...
#endif`,wf="gl_FragColor = linearToOutputTexel( gl_FragColor );",Cf=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function jl(){return new $n({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Go(),fragmentShader:`
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function Jl(){return new $n({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Go(),fragmentShader:`
	...
	`}function zm(r){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===Ha||l===Ga,h=l===Qi||l===tr;if(c||h){let u=t.get(o);const d=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return e===null&&(e=new Kl(r)),u=c?e.fromEquirectangular(o,u):e.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,t.set(o,u),u.texture;if(u!==void 0)return u.texture;{const m=o.image;return c&&m&&m.height>0||h&&m&&i(m)?(e===null&&(e=new Kl(r)),u=c?e.fromEquirectangular(o):e.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,t.set(o,u),o.addEventListener("dispose",s),u.texture):null}}}return o}function i(o){let l=0;const c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function km(r){const t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return t[n]=i,i}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const i=e(n);return i===null&&eh("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function Vm(r,t,e,n){const i={},s=new WeakMap;function a(u){const d=u.target;d.index!==null&&t.remove(d.index);for(const _ in d.attributes)t.remove(d.attributes[_]);for(const _ in d.morphAttributes){const g=d.morphAttributes[_];for(let p=0,f=g.length;p<f;p++)t.remove(g[p])}d.removeEventListener("dispose",a),delete i[d.id];const m=s.get(d);m&&(t.remove(m),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function o(u,d){return i[d.id]===!0||(d.addEventListener("dispose",a),i[d.id]=!0,e.memory.geometries++),d}function l(u){const d=u.attributes;for(const _ in d)t.update(d[_],r.ARRAY_BUFFER);const m=u.morphAttributes;for(const _ in m){const g=m[_];for(let p=0,f=g.length;p<f;p++)t.update(g[p],r.ARRAY_BUFFER)}}function c(u){const d=[],m=u.index,_=u.attributes.position;let g=0;if(m!==null){const S=m.array;g=m.version;for(let v=0,E=S.length;v<E;v+=3){const P=S[v+0],A=S[v+1],b=S[v+2];d.push(P,A,A,b,b,P)}}else if(_!==void 0){const S=_.array;g=_.version;for(let v=0,E=S.length/3-1;v<E;v+=3){const P=v+0,A=v+1,b=v+2;d.push(P,A,A,b,b,P)}}else return;const p=new(th(d)?ch:lh)(d,1);p.version=g;const f=s.get(u);f&&t.remove(f),s.set(u,p)}function h(u){const d=s.get(u);if(d){const m=u.index;m!==null&&d.version<m.version&&c(u)}else c(u);return s.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function Hm(r,t,e){let n;function i(d){n=d}let s,a;function o(d){s=d.type,a=d.bytesPerElement}function l(d,m){r.drawElements(n,m,s,d*a),e.update(m,n,1)}function c(d,m,_){_!==0&&(r.drawElementsInstanced(n,m,s,d*a,_),e.update(m,n,_))}function h(d,m,_){if(_===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,s,d,0,_);let p=0;for(let f=0;f<_;f++)p+=m[f];e.update(p,n,1)}function u(d,m,_,g){if(_===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let f=0;f<d.length;f++)c(d[f]/a,m[f],g[f]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,s,d,0,g,0,_);let f=0;for(let S=0;S<_;S++)f+=m[S];for(let S=0;S<g.length;S++)e.update(f,n,g[S])}}this.setMode=i,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Gm(r){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(e.calls++,a){case r.TRIANGLES:e.triangles+=o*(s/3);break;case r.LINES:e.lines+=o*(s/2);break;case r.LINE_STRIP:e.lines+=o*(s-1);break;case r.LINE_LOOP:e.lines+=o*s;break;case r.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n}}function Wm(r,t,e){const n=new WeakMap,i=new he;function s(a,o,l){const c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(o);if(d===void 0||d.count!==u){let M=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",M)};var m=M;d!==void 0&&d.texture.dispose();const _=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,f=o.morphAttributes.position||[],S=o.morphAttributes.normal||[],v=o.morphAttributes.color||[];let E=0;_===!0&&(E=1),g===!0&&(E=2),p===!0&&(E=3);let P=o.attributes.position.count*E,A=1;P>t.maxTextureSize&&(A=Math.ceil(P/t.maxTextureSize),P=t.maxTextureSize);const b=new Float32Array(P*A*4*u),C=new ih(b,P,A,u);C.type=bn,C.needsUpdate=!0;const x=E*4;for(let R=0;R<u;R++){const O=f[R],F=S[R],H=v[R],W=P*A*4*R;for(let V=0;V<O.count;V++){const Y=V*x;_===!0&&(i.fromBufferAttribute(O,V),b[W+Y+0]=i.x,b[W+Y+1]=i.y,b[W+Y+2]=i.z,b[W+Y+3]=0),g===!0&&(i.fromBufferAttribute(F,V),b[W+Y+4]=i.x,b[W+Y+5]=i.y,b[W+Y+6]=i.z,b[W+Y+7]=0),p===!0&&(i.fromBufferAttribute(H,V),b[W+Y+8]=i.x,b[W+Y+9]=i.y,b[W+Y+10]=i.z,b[W+Y+11]=H.itemSize===4?i.w:1)}}d={count:u,texture:C,size:new zt(P,A)},n.set(o,d),o.addEventListener("dispose",M)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(r,"morphTexture",a.morphTexture,e);else{let _=0;for(let p=0;p<c.length;p++)_+=c[p];const g=o.morphTargetsRelative?1:1-_;l.getUniforms().setValue(r,"morphTargetBaseInfluence",g),l.getUniforms().setValue(r,"morphTargetInfluences",c)}l.getUniforms().setValue(r,"morphTargetsTexture",d.texture,e),l.getUniforms().setValue(r,"morphTargetsTextureSize",d.size)}return{update:s}}function Xm(r,t,e,n){let i=new WeakMap;function s(l){const c=n.render.frame,h=l.geometry,u=t.get(l,h);if(i.get(u)!==c&&(t.update(u),i.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),i.get(l)!==c&&(e.update(l.instanceMatrix,r.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,r.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;i.get(d)!==c&&(d.update(),i.set(d,c))}return u}function a(){i=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:a}}class mh extends Te{constructor(t,e,n,i,s,a,o,l,c,h=qi){if(h!==qi&&h!==nr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===qi&&(n=xi),n===void 0&&h===nr&&(n=er),super(null,i,s,a,o,l,h,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=o!==void 0?o:Re,this.minFilter=l!==void 0?l:Re,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const _h=new Te,Ql=new mh(1,1),gh=new ih,vh=new Pd,xh=new dh,tc=[],ec=[],nc=new Float32Array(16),ic=new Float32Array(9),rc=new Float32Array(4);function pr(r,t,e){const n=r[0];if(n<=0||n>0)return r;const i=t*e;let s=tc[i];if(s===void 0&&(s=new Float32Array(i),tc[i]=s),t!==0){n.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=e,r[a].toArray(s,o)}return s}function ue(r,t){if(r.length!==t.length)return!1;for(let e=0,n=r.length;e<n;e++)if(r[e]!==t[e])return!1;return!0}function de(r,t){for(let e=0,n=t.length;e<n;e++)r[e]=t[e]}function Gs(r,t){let e=ec[t];e===void 0&&(e=new Int32Array(t),ec[t]=e);for(let n=0;n!==t;++n)e[n]=r.allocateTextureUnit();return e}function Ym(r,t){const e=this.cache;e[0]!==t&&(r.uniform1f(this.addr,t),e[0]=t)}function qm(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ue(e,t))return;r.uniform2fv(this.addr,t),de(e,t)}}function $m(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(r.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(ue(e,t))return;r.uniform3fv(this.addr,t),de(e,t)}}function Km(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ue(e,t))return;r.uniform4fv(this.addr,t),de(e,t)}}function Zm(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(ue(e,t))return;r.uniformMatrix2fv(this.addr,!1,t),de(e,t)}else{if(ue(e,n))return;rc.set(n),r.uniformMatrix2fv(this.addr,!1,rc),de(e,n)}}function jm(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(ue(e,t))return;r.uniformMatrix3fv(this.addr,!1,t),de(e,t)}else{if(ue(e,n))return;ic.set(n),r.uniformMatrix3fv(this.addr,!1,ic),de(e,n)}}function Jm(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(ue(e,t))return;r.uniformMatrix4fv(this.addr,!1,t),de(e,t)}else{if(ue(e,n))return;nc.set(n),r.uniformMatrix4fv(this.addr,!1,nc),de(e,n)}}function Qm(r,t){const e=this.cache;e[0]!==t&&(r.uniform1i(this.addr,t),e[0]=t)}function t_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ue(e,t))return;r.uniform2iv(this.addr,t),de(e,t)}}function e_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ue(e,t))return;r.uniform3iv(this.addr,t),de(e,t)}}function n_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ue(e,t))return;r.uniform4iv(this.addr,t),de(e,t)}}function i_(r,t){const e=this.cache;e[0]!==t&&(r.uniform1ui(this.addr,t),e[0]=t)}function r_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ue(e,t))return;r.uniform2uiv(this.addr,t),de(e,t)}}function s_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ue(e,t))return;r.uniform3uiv(this.addr,t),de(e,t)}}function a_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ue(e,t))return;r.uniform4uiv(this.addr,t),de(e,t)}}function o_(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);let s;this.type===r.SAMPLER_2D_SHADOW?(Ql.compareFunction=Qc,s=Ql):s=_h,e.setTexture2D(t||s,i)}function l_(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||vh,i)}function c_(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||xh,i)}function h_(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||gh,i)}function u_(r){switch(r){case 5126:return Ym;case 35664:return qm;case 35665:return $m;case 35666:return Km;case 35674:return Zm;case 35675:return jm;case 35676:return Jm;case 5124:case 35670:return Qm;case 35667:case 35671:return t_;case 35668:case 35672:return e_;case 35669:case 35673:return n_;case 5125:return i_;case 36294:return r_;case 36295:return s_;case 36296:return a_;case 35678:case 36198:case 36298:case 36306:case 35682:return o_;case 35679:case 36299:case 36307:return l_;case 35680:case 36300:case 36308:case 36293:return c_;case 36289:case 36303:case 36311:case 36292:return h_}}function d_(r,t){r.uniform1fv(this.addr,t)}function f_(r,t){const e=pr(t,this.size,2);r.uniform2fv(this.addr,e)}function p_(r,t){const e=pr(t,this.size,3);r.uniform3fv(this.addr,e)}function m_(r,t){const e=pr(t,this.size,4);r.uniform4fv(this.addr,e)}function __(r,t){const e=pr(t,this.size,4);r.uniformMatrix2fv(this.addr,!1,e)}function g_(r,t){const e=pr(t,this.size,9);r.uniformMatrix3fv(this.addr,!1,e)}function v_(r,t){const e=pr(t,this.size,16);r.uniformMatrix4fv(this.addr,!1,e)}function x_(r,t){r.uniform1iv(this.addr,t)}function M_(r,t){r.uniform2iv(this.addr,t)}function S_(r,t){r.uniform3iv(this.addr,t)}function y_(r,t){r.uniform4iv(this.addr,t)}function E_(r,t){r.uniform1uiv(this.addr,t)}function T_(r,t){r.uniform2uiv(this.addr,t)}function A_(r,t){r.uniform3uiv(this.addr,t)}function b_(r,t){r.uniform4uiv(this.addr,t)}function w_(r,t,e){const n=this.cache,i=t.length,s=Gs(e,i);ue(n,s)||(r.uniform1iv(this.addr,s),de(n,s));for(let a=0;a!==i;++a)e.setTexture2D(t[a]||_h,s[a])}function C_(r,t,e){const n=this.cache,i=t.length,s=Gs(e,i);ue(n,s)||(r.uniform1iv(this.addr,s),de(n,s));for(let a=0;a!==i;++a)e.setTexture3D(t[a]||vh,s[a])}function R_(r,t,e){const n=this.cache,i=t.length,s=Gs(e,i);ue(n,s)||(r.uniform1iv(this.addr,s),de(n,s));for(let a=0;a!==i;++a)e.setTextureCube(t[a]||xh,s[a])}function P_(r,t,e){const n=this.cache,i=t.length,s=Gs(e,i);ue(n,s)||(r.uniform1iv(this.addr,s),de(n,s));for(let a=0;a!==i;++a)e.setTexture2DArray(t[a]||gh,s[a])}function L_(r){switch(r){case 5126:return d_;case 35664:return f_;case 35665:return p_;case 35666:return m_;case 35674:return __;case 35675:return g_;case 35676:return v_;case 5124:case 35670:return x_;case 35667:case 35671:return M_;case 35668:case 35672:return S_;case 35669:case 35673:return y_;case 5125:return E_;case 36294:return T_;case 36295:return A_;case 36296:return b_;case 35678:case 36198:case 36298:case 36306:case 35682:return w_;case 35679:case 36299:case 36307:return C_;case 35680:case 36300:case 36308:case 36293:return R_;case 36289:case 36303:case 36311:case 36292:return P_}}class D_{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=u_(e.type)}}class U_{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=L_(e.type)}}class I_{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let s=0,a=i.length;s!==a;++s){const o=i[s];o.setValue(t,e[o.id],n)}}}const wa=/(\w+)(\])?(\[|\.)?/g;function sc(r,t){r.seq.push(t),r.map[t.id]=t}function N_(r,t,e){const n=r.name,i=n.length;for(wa.lastIndex=0;;){const s=wa.exec(n),a=wa.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===i){sc(e,c===void 0?new D_(o,r,t):new U_(o,r,t));break}else{let u=e.map[o];u===void 0&&(u=new I_(o),sc(e,u)),e=u}}}class Ss{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=t.getActiveUniform(e,i),a=t.getUniformLocation(e,s.name);N_(s,a,this)}}setValue(t,e,n,i){const s=this.map[e];s!==void 0&&s.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let s=0,a=e.length;s!==a;++s){const o=e[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,s=t.length;i!==s;++i){const a=t[i];a.id in e&&n.push(a)}return n}}function ac(r,t,e){const n=r.createShader(t);return r.shaderSource(n,e),r.compileShader(n),n}const F_=37297;let O_=0;function B_(r,t){const e=r.split(`
`),n=[],i=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let a=i;a<s;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}function z_(r){const t=$t.getPrimaries($t.workingColorSpace),e=$t.getPrimaries(r);let n;switch(t===e?n="":t===Cs&&e===ws?n="LinearDisplayP3ToLinearSRGB":t===ws&&e===Cs&&(n="LinearSRGBToLinearDisplayP3"),r){case Jn:case ks:return[n,"LinearTransferOETF"];case ln:case Vo:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",r),[n,"LinearTransferOETF"]}}function oc(r,t,e){const n=r.getShaderParameter(t,r.COMPILE_STATUS),i=r.getShaderInfoLog(t).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const a=parseInt(s[1]);return e.toUpperCase()+`

`+i+`

`+B_(r.getShaderSource(t),a)}else return i}function k_(r,t){const e=z_(t);return`vec4 ${r}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function V_(r,t){let e;switch(t){case rd:e="Linear";break;case sd:e="Reinhard";break;case ad:e="OptimizedCineon";break;case od:e="ACESFilmic";break;case cd:e="AgX";break;case hd:e="Neutral";break;case ld:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+r+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function H_(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Sr).join(`
`)}function G_(r){const t=[];for(const e in r){const n=r[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function W_(r,t){const e={},n=r.getProgramParameter(t,r.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=r.getActiveAttrib(t,i),a=s.name;let o=1;s.type===r.FLOAT_MAT2&&(o=2),s.type===r.FLOAT_MAT3&&(o=3),s.type===r.FLOAT_MAT4&&(o=4),e[a]={type:s.type,location:r.getAttribLocation(t,a),locationSize:o}}return e}function Sr(r){return r!==""}function lc(r,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function cc(r,t){return r.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const X_=/^[ \t]*#include +<([\w\d./]+)>/gm;function Mo(r){return r.replace(X_,q_)}const Y_=new Map;function q_(r,t){let e=Rt[t];if(e===void 0){const n=Y_.get(t);if(n!==void 0)e=Rt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Mo(e)}const $_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function hc(r){return r.replace($_,K_)}function K_(r,t,e,n){let i="";for(let s=parseInt(t);s<parseInt(e);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function uc(r){let t=`precision ${r.precision} float;
...
#define LOW_PRECISION`),t}function Z_(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===zc?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Pu?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===En&&(t="SHADOWMAP_TYPE_VSM"),t}function j_(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Qi:case tr:t="ENVMAP_TYPE_CUBE";break;case zs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function J_(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case tr:t="ENVMAP_MODE_REFRACTION";break}return t}function Q_(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case kc:t="ENVMAP_BLENDING_MULTIPLY";break;case nd:t="ENVMAP_BLENDING_MIX";break;case id:t="ENVMAP_BLENDING_ADD";break}return t}function tg(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function eg(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Z_(e),c=j_(e),h=J_(e),u=Q_(e),d=tg(e),m=H_(e),_=G_(s),g=i.createProgram();let p,f,S=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+f);const v=S+p+a,E=S+f+o,P=ac(i,i.VERTEX_SHADER,v),A=ac(i,i.FRAGMENT_SHADER,E);i.attachShader(g,P),i.attachShader(g,A),e.index0AttributeName!==void 0?i.bindAttribLocation(g,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function b(R){if(r.debug.checkShaderErrors){const O=i.getProgramInfoLog(g).trim(),F=i.getShaderInfoLog(P).trim(),H=i.getShaderInfoLog(A).trim();let W=!0,V=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if(W=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,g,P,A);else{const Y=oc(i,P,"vertex"),G=oc(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
...
}`;function n0(r){const t=document.createElement("style");t.innerHTML=r;const e=document.querySelector("head link[rel=stylesheet], head style");e?document.head.insertBefore(t,e):document.head.appendChild(t)}let yc=!1;class Ko{constructor({parent:t,autoPlace:e=t===void 0,container:n,width:i,title:s="Controls",closeFolders:a=!1,injectStyles:o=!0,touchStyles:l=!0}={}){if(this.parent=t,this.root=t?t.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",c=>{(c.code==="Enter"||c.code==="Space")&&(c.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(s),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),l&&this.domElement.classList.add("allow-touch-styles"),!yc&&o&&(n0(e0),yc=!0),n?n.appendChild(this.domElement):e&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),i&&this.domElement.style.setProperty("--width",i+"px"),this._closeFolders=a}add(t,e,n,i,s){if(Object(n)===n)return new Qg(this,t,e,n);const a=t[e];switch(typeof a){case"number":return new Jg(this,t,e,n,i,s);case"boolean":return new Xg(this,t,e);case"string":return new t0(this,t,e);case"function":return new Pa(this,t,e)}console.error(`gui.add failed
	property:`,e,`
	object:`,t,`
	value:`,a)}addColor(t,e,n=1){return new jg(this,t,e,n)}addFolder(t){const e=new Ko({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof Pa||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof Pa)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=s=>{s.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const i=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=i+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}function Tn(r){if(r===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return r}function yh(r,t){r.prototype=Object.create(t.prototype),r.prototype.constructor=r,r.__proto__=t}/*!
 * GSAP 3.5.1
 * https://greensock.com
 *
...
*/var Ke={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},rr={duration:.5,overwrite:!1,delay:0},pn=1e8,Yt=1/pn,Eo=Math.PI*2,i0=Eo/4,r0=0,Eh=Math.sqrt,s0=Math.cos,a0=Math.sin,Se=function(t){return typeof t=="string"},pe=function(t){return typeof t=="function"},rn=function(t){return typeof t=="number"},Zo=function(t){return typeof t>"u"},Dn=function(t){return typeof t=="object"},Le=function(t){return t!==!1},Th=function(){return typeof window<"u"},Ec=function(t){return pe(t)||Se(t)},Ah=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},$e=Array.isArray,To=/(?:-?\.?\d|\.)+/gi,bh=/[-+=.]*\d+[.e\-+]*\d*[e\-\+]*\d*/g,Gi=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,La=/[-+=.]*\d+(?:\.|e-|e)*\d*/gi,wh=/[+-]=-?[\.\d]+/,Ch=/[#\-+.]*\b[a-z\d-=+%.]+/gi,ce,on,Ao,Rh,Ve={},Ps={},Ph,Lh=function(t){return(Ps=sr(t,Ve))&&_n},jo=function(t,e){return console.warn("Invalid property",t,"set to",e,"Missing plugin? gsap.registerPlugin()")},Dh=function(t,e){return!e&&console.warn(t)},Uh=function(t,e){return t&&(Ve[t]=e)&&Ps&&(Ps[t]=e)||Ve},Vr=function(){return 0},Jo={},Yn=[],bo={},Ih,Oe={},Da={},Tc=30,ys=[],Qo="",tl=function(t){var e=t[0],n,i;if(Dn(e)||pe(e)||(t=[t]),!(n=(e._gsap||{}).harness)){for(i=ys.length;i--&&!ys[i].targetTest(e););n=ys[i]}for(i=t.length;i--;)t[i]&&(t[i]._gsap||(t[i]._gsap=new eu(t[i],n)))||t.splice(i,1);return t},gi=function(t){return t._gsap||tl(un(t))[0]._gsap},Nh=function(t,e,n){return(n=t[e])&&pe(n)?t[e]():Zo(n)&&t.getAttribute&&t.getAttribute(e)||n},ze=function(t,e){return(t=t.split(",")).forEach(e)||t},Ft=function(t){return Math.round(t*1e5)/1e5||0},o0=function(t,e){for(var n=e.length,i=0;t.indexOf(e[i])<0&&++i<n;);return i<n},wr=function(t,e,n){var i=rn(t[1]),s=(i?2:1)+(e<2?0:1),a=t[s],o;if(i&&(a.duration=t[1]),a.parent=n,e){for(o=a;n&&!("immediateRender"in o);)o=n.vars.defaults||{},n=Le(n.vars.inherit)&&n.parent;a.immediateRender=Le(o.immediateRender),e<2?a.runBackwards=1:a.startAt=t[s-1]}return a},Ls=function(){var t=Yn.length,e=Yn.slice(0),n,i;for(bo={},Yn.length=0,n=0;n<t;n++)i=e[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},Fh=function(t,e,n,i){Yn.length&&Ls(),t.render(e,n,i),Yn.length&&Ls()},Oh=function(t){var e=parseFloat(t);return(e||e===0)&&(t+"").match(Ch).length<2?e:Se(t)?t.trim():t},Bh=function(t){return t},Ze=function(t,e){for(var n in e)n in t||(t[n]=e[n]);return t},l0=function(t,e){for(var n in e)n in t||n==="duration"||n==="ease"||(t[n]=e[n])},sr=function(t,e){for(var n in e)t[n]=e[n];return t},Ac=function r(t,e){for(var n in e)t[n]=Dn(e[n])?r(t[n]||(t[n]={}),e[n]):e[n];return t},wo=function(t,e){var n={},i;for(i in t)i in e||(n[i]=t[i]);return n},Es=function(t){var e=t.parent||ce,n=t.keyframes?l0:Ze;if(Le(t.inherit))for(;e;)n(t,e.vars.defaults),e=e.parent||e._dp;return t},c0=function(t,e){for(var n=t.length,i=n===e.length;i&&n--&&t[n]===e[n];);return n<0},h0=function(t,e,n,i,s){var a=t[i],o;if(s)for(o=e[s];a&&a[s]>o;)a=a._prev;return a?(e._next=a._next,a._next=e):(e._next=t[n],t[n]=e),e._next?e._next._prev=e:t[i]=e,e._prev=a,e.parent=e._dp=t,e},Ws=function(t,e,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var s=e._prev,a=e._next;s?s._next=a:t[n]===e&&(t[n]=a),a?a._prev=s:t[i]===e&&(t[i]=s),e._next=e._prev=e.parent=null},Kn=function(t,e){t.parent&&(!e||t.parent.autoRemoveChildren)&&t.parent.remove(t),t._act=0},vi=function(t,e){if(t&&(!e||e._end>t._dur||e._start<0))for(var n=t;n;)n._dirty=1,n=n.parent;return t},u0=function(t){for(var e=t.parent;e&&e.parent;)e._dirty=1,e.totalDuration(),e=e.parent;return t},d0=function r(t){return!t||t._ts&&r(t.parent)},bc=function(t){return t._repeat?ar(t._tTime,t=t.duration()+t._rDelay)*t:0},ar=function(t,e){return(t/=e)&&~~t===t?~~t-1:~~t},Ds=function(t,e){return(t-e._start)*e._ts+(e._ts>=0?0:e._dirty?e.totalDuration():e._tDur)},el=function(t){return t._end=Ft(t._start+(t._tDur/Math.abs(t._ts||t._rts||Yt)||0))},zh=function(t,e){var n=t._dp;return n&&n.smoothChildTiming&&t._ts&&(t._start=Ft(t._dp._time-(t._ts>0?e/t._ts:((t._dirty?t.totalDuration():t._tDur)-e)/-t._ts)),el(t),n._dirty||vi(n,t)),t},nl=function(t,e){var n;if((e._time||e._initted&&!e._dur)&&(n=Ds(t.rawTime(),e),(!e._dur||Hr(0,e.totalDuration(),n)-e._tTime>Yt)&&e.render(n,!0)),vi(t,e)._dp&&t._initted&&t._time>=t._dur&&t._ts){if(t._dur<t.duration())for(n=t;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;t._zTime=-Yt}},Cn=function(t,e,n,i){return e.parent&&Kn(e),e._start=Ft(n+e._delay),e._end=Ft(e._start+(e.totalDuration()/Math.abs(e.timeScale())||0)),h0(t,e,"_first","_last",t._sort?"_start":0),t._recent=e,i||nl(t,e),t},kh=function(t,e){return(Ve.ScrollTrigger||jo("scrollTrigger",e))&&Ve.ScrollTrigger.create(e,t)},Vh=function(t,e,n,i){if(U0(t,e),!t._initted)return 1;if(!n&&t._pt&&(t._dur&&t.vars.lazy!==!1||!t._dur&&t.vars.lazy)&&Ih!==Xe.frame)return Yn.push(t),t._lazy=[e,i],1},f0=function(t,e,n,i){var s=t.ratio,a=e<0||!e&&s&&!t._start&&t._zTime>Yt&&!t._dp._lock||(t._ts<0||t._dp._ts<0)&&t.data!=="isFromStart"&&t.data!=="isStart"?0:1,o=t._rDelay,l=0,c,h,u;if(o&&t._repeat&&(l=Hr(0,t._tDur,e),h=ar(l,o),u=ar(t._tTime,o),h!==u&&(s=1-a,t.vars.repeatRefresh&&t._initted&&t.invalidate())),a!==s||i||t._zTime===Yt||!e&&t._zTime){if(!t._initted&&Vh(t,e,i,n))return;for(u=t._zTime,t._zTime=e||(n?Yt:0),n||(n=e&&!u),t.ratio=a,t._from&&(a=1-a),t._time=0,t._tTime=l,n||Be(t,"onStart"),c=t._pt;c;)c.r(a,c.d),c=c._next;t._startAt&&e<0&&t._startAt.render(e,!0,!0),t._onUpdate&&!n&&Be(t,"onUpdate"),l&&t._repeat&&!n&&t.parent&&Be(t,"onRepeat"),(e>=t._tDur||e<0)&&t.ratio===a&&(a&&Kn(t,1),n||(Be(t,a?"onComplete":"onReverseComplete",!0),t._prom&&t._prom()))}else t._zTime||(t._zTime=e)},p0=function(t,e,n){var i;if(n>e)for(i=t._first;i&&i._start<=n;){if(!i._dur&&i.data==="isPause"&&i._start>e)return i;i=i._next}else for(i=t._last;i&&i._start>=n;){if(!i._dur&&i.data==="isPause"&&i._start<e)return i;i=i._prev}},or=function(t,e,n,i){var s=t._repeat,a=Ft(e)||0,o=t._tTime/t._tDur;return o&&!i&&(t._time*=a/t._dur),t._dur=a,t._tDur=s?s<0?1e10:Ft(a*(s+1)+t._rDelay*s):a,o&&!i?zh(t,t._tTime=t._tDur*o):t.parent&&el(t),n||vi(t.parent,t),t},wc=function(t){return t instanceof Ce?vi(t):or(t,t._dur)},m0={_start:0,endTime:Vr},ye=function r(t,e){var n=t.labels,i=t._recent||m0,s=t.duration()>=pn?i.endTime(!1):t._dur,a,o;return Se(e)&&(isNaN(e)||e in n)?(a=e.charAt(0),a==="<"||a===">"?(a==="<"?i._start:i.endTime(i._repeat>=0))+(parseFloat(e.substr(1))||0):(a=e.indexOf("="),a<0?(e in n||(n[e]=s),n[e]):(o=+(e.charAt(a-1)+e.substr(a+1)),a>1?r(t,e.substr(0,a-1))+o:s+o))):e==null?s:+e},Qn=function(t,e){return t||t===0?e(t):e},Hr=function(t,e,n){return n<t?t:n>e?e:n},mn=function(t){return(t=(t+"").substr((parseFloat(t)+"").length))&&isNaN(t)?t:""},_0=function(t,e,n){return Qn(n,function(i){return Hr(t,e,i)})},Co=[].slice,Hh=function(t,e){return t&&Dn(t)&&"length"in t&&(!e&&!t.length||t.length-1 in t&&Dn(t[0]))&&!t.nodeType&&t!==on},g0=function(t,e,n){return n===void 0&&(n=[]),t.forEach(function(i){var s;return Se(i)&&!e||Hh(i,1)?(s=n).push.apply(s,un(i)):n.push(i)})||n},un=function(t,e){return Se(t)&&!e&&(Ao||!lr())?Co.call(Rh.querySelectorAll(t),0):$e(t)?g0(t,e):Hh(t)?Co.call(t,0):t?[t]:[]},Gh=function(t){return t.sort(function(){return .5-Math.random()})},Wh=function(t){if(pe(t))return t;var e=Dn(t)?t:{each:t},n=Zi(e.ease),i=e.from||0,s=parseFloat(e.base)||0,a={},o=i>0&&i<1,l=isNaN(i)||o,c=e.axis,h=i,u=i;return Se(i)?h=u={center:.5,edges:.5,end:1}[i]||0:!o&&l&&(h=i[0],u=i[1]),function(d,m,_){var g=(_||e).length,p=a[g],f,S,v,E,P,A,b,C,x;if(!p){if(x=e.grid==="auto"?0:(e.grid||[1,pn])[1],!x){for(b=-pn;b<(b=_[x++].getBoundingClientRect().left)&&x<g;);x--}for(p=a[g]=[],f=l?Math.min(x,g)*h-.5:i%x,S=l?g*u/x-.5:i/x|0,b=0,C=pn,A=0;A<g;A++)v=A%x-f,E=S-(A/x|0),p[A]=P=c?Math.abs(c==="y"?E:v):Eh(v*v+E*E),P>b&&(b=P),P<C&&(C=P);i==="random"&&Gh(p),p.max=b-C,p.min=C,p.v=g=(parseFloat(e.amount)||parseFloat(e.each)*(x>g?g-1:c?c==="y"?g/x:x:Math.max(x,g/x))||0)*(i==="edges"?-1:1),p.b=g<0?s-g:s,p.u=mn(e.amount||e.each)||0,n=n&&g<0?Jh(n):n}return g=(p[d]-p.min)/p.max||0,Ft(p.b+(n?n(g):g)*p.v)+p.u}},Ro=function(t){var e=t<1?Math.pow(10,(t+"").length-2):1;return function(n){return Math.floor(Math.round(parseFloat(n)/t)*t*e)/e+(rn(n)?0:mn(n))}},Xh=function(t,e){var n=$e(t),i,s;return!n&&Dn(t)&&(i=n=t.radius||pn,t.values?(t=un(t.values),(s=!rn(t[0]))&&(i*=i)):t=Ro(t.increment)),Qn(e,n?pe(t)?function(a){return s=t(a),Math.abs(s-a)<=i?s:a}:function(a){for(var o=parseFloat(s?a.x:a),l=parseFloat(s?a.y:0),c=pn,h=0,u=t.length,d,m;u--;)s?(d=t[u].x-o,m=t[u].y-l,d=d*d+m*m):d=Math.abs(t[u]-o),d<c&&(c=d,h=u);return h=!i||c<=i?t[h]:a,s||h===a||rn(a)?h:h+mn(a)}:Ro(t))},Yh=function(t,e,n,i){return Qn($e(t)?!e:n===!0?!!(n=0):!i,function(){return $e(t)?t[~~(Math.random()*t.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((t+Math.random()*(e-t))/n)*n*i)/i})},v0=function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];return function(i){return e.reduce(function(s,a){return a(s)},i)}},x0=function(t,e){return function(n){return t(parseFloat(n))+(e||mn(n))}},M0=function(t,e,n){return $h(t,e,0,1,n)},qh=function(t,e,n){return Qn(n,function(i){return t[~~e(i)]})},S0=function r(t,e,n){var i=e-t;return $e(t)?qh(t,r(0,t.length),e):Qn(n,function(s){return(i+(s-t)%i)%i+t})},y0=function r(t,e,n){var i=e-t,s=i*2;return $e(t)?qh(t,r(0,t.length-1),e):Qn(n,function(a){return a=(s+(a-t)%s)%s||0,t+(a>i?s-a:a)})},Xs=function(t){for(var e=0,n="",i,s,a,o;~(i=t.indexOf("random(",e));)a=t.indexOf(")",i),o=t.charAt(i+7)==="[",s=t.substr(i+7,a-i-7).match(o?Ch:To),n+=t.substr(e,i-e)+Yh(o?s:+s[0],o?0:+s[1],+s[2]||1e-5),e=a+1;return n+t.substr(e,t.length-e)},$h=function(t,e,n,i,s){var a=e-t,o=i-n;return Qn(s,function(l){return n+((l-t)/a*o||0)})},E0=function r(t,e,n,i){var s=isNaN(t+e)?0:function(m){return(1-m)*t+m*e};if(!s){var a=Se(t),o={},l,c,h,u,d;if(n===!0&&(i=1)&&(n=null),a)t={p:t},e={p:e};else if($e(t)&&!$e(e)){for(h=[],u=t.length,d=u-2,c=1;c<u;c++)h.push(r(t[c-1],t[c]));u--,s=function(_){_*=u;var g=Math.min(d,~~_);return h[g](_-g)},n=e}else i||(t=sr($e(t)?[]:{},t));if(!h){for(l in e)il.call(o,t,l,"get",e[l]);s=function(_){return al(_,o)||(a?t.p:t)}}}return Qn(n,s)},Cc=function(t,e,n){var i=t.labels,s=pn,a,o,l;for(a in i)o=i[a]-e,o<0==!!n&&o&&s>(o=Math.abs(o))&&(l=a,s=o);return l},Be=function(t,e,n){var i=t.vars,s=i[e],a,o;if(s)return a=i[e+"Params"],o=i.callbackScope||t,n&&Yn.length&&Ls(),a?s.apply(o,a):s.call(o)},Er=function(t){return Kn(t),t.progress()<1&&Be(t,"onInterrupt"),t},Wi,T0=function(t){t=!t.name&&t.default||t;var e=t.name,n=pe(t),i=e&&!n&&t.init?function(){this._props=[]}:t,s={init:Vr,render:al,add:il,kill:k0,modifier:z0,rawVars:0},a={targetTest:0,get:0,getSetter:sl,aliases:{},register:0};if(lr(),t!==i){if(Oe[e])return;Ze(i,Ze(wo(t,s),a)),sr(i.prototype,sr(s,wo(t,a))),Oe[i.prop=e]=i,t.targetTest&&(ys.push(i),Jo[e]=1),e=(e==="css"?"CSS":e.charAt(0).toUpperCase()+e.substr(1))+"Plugin"}Uh(e,i),t.register&&t.register(_n,i,De)},jt=255,Tr={aqua:[0,jt,jt],lime:[0,jt,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,jt],navy:[0,0,128],white:[jt,jt,jt],olive:[128,128,0],yellow:[jt,jt,0],orange:[jt,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[jt,0,0],pink:[jt,192,203],cyan:[0,jt,jt],transparent:[jt,jt,jt,0]},Ua=function(t,e,n){return t=t<0?t+1:t>1?t-1:t,(t*6<1?e+(n-e)*t*6:t<.5?n:t*3<2?e+(n-e)*(2/3-t)*6:e)*jt+.5|0},Kh=function(t,e,n){var i=t?rn(t)?[t>>16,t>>8&jt,t&jt]:0:Tr.black,s,a,o,l,c,h,u,d,m,_;if(!i){if(t.substr(-1)===","&&(t=t.substr(0,t.length-1)),Tr[t])i=Tr[t];else if(t.charAt(0)==="#")t.length===4&&(s=t.charAt(1),a=t.charAt(2),o=t.charAt(3),t="#"+s+s+a+a+o+o),t=parseInt(t.substr(1),16),i=[t>>16,t>>8&jt,t&jt];else if(t.substr(0,3)==="hsl"){if(i=_=t.match(To),!e)l=+i[0]%360/360,c=+i[1]/100,h=+i[2]/100,a=h<=.5?h*(c+1):h+c-h*c,s=h*2-a,i.length>3&&(i[3]*=1),i[0]=Ua(l+1/3,s,a),i[1]=Ua(l,s,a),i[2]=Ua(l-1/3,s,a);else if(~t.indexOf("="))return i=t.match(bh),n&&i.length<4&&(i[3]=1),i}else i=t.match(To)||Tr.transparent;i=i.map(Number)}return e&&!_&&(s=i[0]/jt,a=i[1]/jt,o=i[2]/jt,u=Math.max(s,a,o),d=Math.min(s,a,o),h=(u+d)/2,u===d?l=c=0:(m=u-d,c=h>.5?m/(2-u-d):m/(u+d),l=u===s?(a-o)/m+(a<o?6:0):u===a?(o-s)/m+2:(s-a)/m+4,l*=60),i[0]=~~(l+.5),i[1]=~~(c*100+.5),i[2]=~~(h*100+.5)),n&&i.length<4&&(i[3]=1),i},Zh=function(t){var e=[],n=[],i=-1;return t.split(Ki).forEach(function(s){var a=s.match(Gi)||[];e.push.apply(e,a),n.push(i+=a.length+1)}),e.c=n,e},Rc=function(t,e,n){var i="",s=(t+i).match(Ki),a=e?"hsla(":"rgba(",o=0,l,c,h,u;if(!s)return t;if(s=s.map(function(d){return(d=Kh(d,e,1))&&a+(e?d[0]+","+d[1]+"%,"+d[2]+"%,"+d[3]:d.join(","))+")"}),n&&(h=Zh(t),l=n.c,l.join(i)!==h.c.join(i)))for(c=t.replace(Ki,"1").split(Gi),u=c.length-1;o<u;o++)i+=c[o]+(~l.indexOf(o)?s.shift()||a+"0,0,0,0)":(h.length?h:s.length?s:n).shift());if(!c)for(c=t.split(Ki),u=c.length-1;o<u;o++)i+=c[o]+s[o];return i+c[u]},Ki=function(){var r="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3}){1,2}\\b",t;for(t in Tr)r+="|"+t+"\\b";return new RegExp(r+")","gi")}(),A0=/hsl[a]?\(/,jh=function(t){var e=t.join(" "),n;if(Ki.lastIndex=0,Ki.test(e))return n=A0.test(e),t[1]=Rc(t[1],n),t[0]=Rc(t[0],n,Zh(t[1])),!0},Us,Xe=function(){var r=Date.now,t=500,e=33,n=r(),i=n,s=1e3/240,a=s,o=[],l,c,h,u,d,m,_=function g(p){var f=r()-i,S=p===!0,v,E,P,A;if(f>t&&(n+=f-e),i+=f,P=i-n,v=P-a,(v>0||S)&&(A=++u.frame,d=P-u.time*1e3,u.time=P=P/1e3,a+=v+(v>=s?4:s-v),E=1),S||(l=c(g)),E)for(m=0;m<o.length;m++)o[m](P,d,A,p)};return u={time:0,frame:0,tick:function(){_(!0)},deltaRatio:function(p){return d/(1e3/(p||60))},wake:function(){Ph&&(!Ao&&Th()&&(on=Ao=window,Rh=on.document||{},Ve.gsap=_n,(on.gsapVersions||(on.gsapVersions=[])).push(_n.version),Lh(Ps||on.GreenSockGlobals||!on.gsap&&on||{}),h=on.requestAnimationFrame),l&&u.sleep(),c=h||function(p){return setTimeout(p,a-u.time*1e3+1|0)},Us=1,_(2))},sleep:function(){(h?on.cancelAnimationFrame:clearTimeout)(l),Us=0,c=Vr},lagSmoothing:function(p,f){t=p||1/Yt,e=Math.min(f,t,0)},fps:function(p){s=1e3/(p||240),a=u.time*1e3+s},add:function(p){o.indexOf(p)<0&&o.push(p),lr()},remove:function(p){var f;~(f=o.indexOf(p))&&o.splice(f,1)&&m>=f&&m--},_listeners:o},u}(),lr=function(){return!Us&&Xe.wake()},Bt={},b0=/^[\d.\-M][\d.\-,\s]/,w0=/["']/g,C0=function(t){for(var e={},n=t.substr(1,t.length-3).split(":"),i=n[0],s=1,a=n.length,o,l,c;s<a;s++)l=n[s],o=s!==a-1?l.lastIndexOf(","):l.length,c=l.substr(0,o),e[i]=isNaN(c)?c.replace(w0,"").trim():+c,i=l.substr(o+1).trim();return e},R0=function(t){var e=t.indexOf("(")+1,n=t.indexOf(")"),i=t.indexOf("(",e);return t.substring(e,~i&&i<n?t.indexOf(")",n+1):n)},P0=function(t){var e=(t+"").split("("),n=Bt[e[0]];return n&&e.length>1&&n.config?n.config.apply(null,~t.indexOf("{")?[C0(e[1])]:R0(t).split(",").map(Oh)):Bt._CE&&b0.test(t)?Bt._CE("",t):n},Jh=function(t){return function(e){return 1-t(1-e)}},Qh=function r(t,e){for(var n=t._first,i;n;)n instanceof Ce?r(n,e):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==e&&(n.timeline?r(n.timeline,e):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=e)),n=n._next},Zi=function(t,e){return t&&(pe(t)?t:Bt[t]||P0(t))||e},yi=function(t,e,n,i){n===void 0&&(n=function(l){return 1-e(1-l)}),i===void 0&&(i=function(l){return l<.5?e(l*2)/2:1-e((1-l)*2)/2});var s={easeIn:e,easeOut:n,easeInOut:i},a;return ze(t,function(o){Bt[o]=Ve[o]=s,Bt[a=o.toLowerCase()]=n;for(var l in s)Bt[a+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=Bt[o+"."+l]=s[l]}),s},tu=function(t){return function(e){return e<.5?(1-t(1-e*2))/2:.5+t((e-.5)*2)/2}},Ia=function r(t,e,n){var i=e>=1?e:1,s=(n||(t?.3:.45))/(e<1?e:1),a=s/Eo*(Math.asin(1/i)||0),o=function(h){return h===1?1:i*Math.pow(2,-10*h)*a0((h-a)*s)+1},l=t==="out"?o:t==="in"?function(c){return 1-o(1-c)}:tu(o);return s=Eo/s,l.config=function(c,h){return r(t,c,h)},l},Na=function r(t,e){e===void 0&&(e=1.70158);var n=function(a){return a?--a*a*((e+1)*a+e)+1:0},i=t==="out"?n:t==="in"?function(s){return 1-n(1-s)}:tu(n);return i.config=function(s){return r(t,s)},i};ze("Linear,Quad,Cubic,Quart,Quint,Strong",function(r,t){var e=t<5?t+1:t;yi(r+",Power"+(e-1),t?function(n){return Math.pow(n,e)}:function(n){return n},function(n){return 1-Math.pow(1-n,e)},function(n){return n<.5?Math.pow(n*2,e)/2:1-Math.pow((1-n)*2,e)/2})});Bt.Linear.easeNone=Bt.none=Bt.Linear.easeIn;yi("Elastic",Ia("in"),Ia("out"),Ia());(function(r,t){var e=1/t,n=2*e,i=2.5*e,s=function(o){return o<e?r*o*o:o<n?r*Math.pow(o-1.5/t,2)+.75:o<i?r*(o-=2.25/t)*o+.9375:r*Math.pow(o-2.625/t,2)+.984375};yi("Bounce",function(a){return 1-s(1-a)},s)})(7.5625,2.75);yi("Expo",function(r){return r?Math.pow(2,10*(r-1)):0});yi("Circ",function(r){return-(Eh(1-r*r)-1)});yi("Sine",function(r){return r===1?1:-s0(r*i0)+1});yi("Back",Na("in"),Na("out"),Na());Bt.SteppedEase=Bt.steps=Ve.SteppedEase={config:function(t,e){t===void 0&&(t=1);var n=1/t,i=t+(e?0:1),s=e?1:0,a=1-Yt;return function(o){return((i*Hr(0,a,o)|0)+s)*n}}};rr.ease=Bt["quad.out"];ze("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(r){return Qo+=r+","+r+"Params,"});var eu=function(t,e){this.id=r0++,t._gsap=this,this.target=t,this.harness=e,this.get=e?e.get:Nh,this.set=e?e.getSetter:sl},Ur=function(){function r(e,n){var i=e.parent||ce;this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,or(this,+e.duration,1,1),this.data=e.data,Us||Xe.wake(),i&&Cn(i,this,n||n===0?n:i._time,1),e.reversed&&this.reverse(),e.paused&&this.paused(!0)}var t=r.prototype;return t.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},t.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},t.totalDuration=function(n){return arguments.length?(this._dirty=0,or(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(n,i){if(lr(),!arguments.length)return this._tTime;var s=this._dp;if(s&&s.smoothChildTiming&&this._ts){for(zh(this,n);s.parent;)s.parent._time!==s._start+(s._ts>=0?s._tTime/s._ts:(s.totalDuration()-s._tTime)/-s._ts)&&s.totalTime(s._tTime,!0),s=s.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&Cn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===Yt||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),Fh(this,n,i)),this},t.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+bc(this))%this._dur||(n?this._dur:0),i):this._time},t.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.ratio},t.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+bc(this),i):this.duration()?Math.min(1,this._time/this._dur):this.ratio},t.iteration=function(n,i){var s=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*s,i):this._repeat?ar(this._tTime,s)+1:1},t.timeScale=function(n){if(!arguments.length)return this._rts===-Yt?0:this._rts;if(this._rts===n)return this;var i=this.parent&&this._ts?Ds(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-Yt?0:this._rts,u0(this.totalTime(Hr(-this._delay,this._tDur,i),!0))},t.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(lr(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&(this._tTime-=Yt)&&Math.abs(this._zTime)!==Yt))),this):this._ps},t.startTime=function(n){if(arguments.length){this._start=n;var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&Cn(i,this,n-this._delay),this}return this._start},t.endTime=function(n){return this._start+(Le(n)?this.totalDuration():this.duration())/Math.abs(this._ts)},t.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Ds(i.rawTime(n),this):this._tTime:this._tTime},t.globalTime=function(n){for(var i=this,s=arguments.length?n:i.rawTime();i;)s=i._start+s/(i._ts||1),i=i._dp;return s},t.repeat=function(n){return arguments.length?(this._repeat=n,wc(this)):this._repeat},t.repeatDelay=function(n){return arguments.length?(this._rDelay=n,wc(this)):this._rDelay},t.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},t.seek=function(n,i){return this.totalTime(ye(this,n),Le(i))},t.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,Le(i))},t.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},t.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},t.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-Yt:0)),this):this._rts<0},t.invalidate=function(){return this._initted=0,this._zTime=-Yt,this},t.isActive=function(){var n=this.parent||this._dp,i=this._start,s;return!!(!n||this._ts&&this._initted&&n.isActive()&&(s=n.rawTime(!0))>=i&&s<this.endTime(!0)-Yt)},t.eventCallback=function(n,i,s){var a=this.vars;return arguments.length>1?(i?(a[n]=i,s&&(a[n+"Params"]=s),n==="onUpdate"&&(this._onUpdate=i)):delete a[n],this):a[n]},t.then=function(n){var i=this;return new Promise(function(s){var a=pe(n)?n:Bh,o=function(){var c=i.then;i.then=null,pe(a)&&(a=a(i))&&(a.then||a===i)&&(i.then=c),s(a),i.then=c};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?o():i._prom=o})},t.kill=function(){Er(this)},r}();Ze(Ur.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-Yt,_prom:0,_ps:!1,_rts:1});var Ce=function(r){yh(t,r);function t(n,i){var s;return n===void 0&&(n={}),s=r.call(this,n,i)||this,s.labels={},s.smoothChildTiming=!!n.smoothChildTiming,s.autoRemoveChildren=!!n.autoRemoveChildren,s._sort=Le(n.sortChildren),s.parent&&nl(s.parent,Tn(s)),n.scrollTrigger&&kh(Tn(s),n.scrollTrigger),s}var e=t.prototype;return e.to=function(i,s,a){return new le(i,wr(arguments,0,this),ye(this,rn(s)?arguments[3]:a)),this},e.from=function(i,s,a){return new le(i,wr(arguments,1,this),ye(this,rn(s)?arguments[3]:a)),this},e.fromTo=function(i,s,a,o){return new le(i,wr(arguments,2,this),ye(this,rn(s)?arguments[4]:o)),this},e.set=function(i,s,a){return s.duration=0,s.parent=this,Es(s).repeatDelay||(s.repeat=0),s.immediateRender=!!s.immediateRender,new le(i,s,ye(this,a),1),this},e.call=function(i,s,a){return Cn(this,le.delayedCall(0,i,s),ye(this,a))},e.staggerTo=function(i,s,a,o,l,c,h){return a.duration=s,a.stagger=a.stagger||o,a.onComplete=c,a.onCompleteParams=h,a.parent=this,new le(i,a,ye(this,l)),this},e.staggerFrom=function(i,s,a,o,l,c,h){return a.runBackwards=1,Es(a).immediateRender=Le(a.immediateRender),this.staggerTo(i,s,a,o,l,c,h)},e.staggerFromTo=function(i,s,a,o,l,c,h,u){return o.startAt=a,Es(o).immediateRender=Le(o.immediateRender),this.staggerTo(i,s,o,l,c,h,u)},e.render=function(i,s,a){var o=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,h=this!==ce&&i>l-Yt&&i>=0?l:i<Yt?0:i,u=this._zTime<0!=i<0&&(this._initted||!c),d,m,_,g,p,f,S,v,E,P,A,b;if(h!==this._tTime||a||u){if(o!==this._time&&c&&(h+=this._time-o,i+=this._time-o),d=h,E=this._start,v=this._ts,f=!v,u&&(c||(o=this._zTime),(i||!s)&&(this._zTime=i)),this._repeat&&(A=this._yoyo,p=c+this._rDelay,d=Ft(h%p),h===l?(g=this._repeat,d=c):(g=~~(h/p),g&&g===h/p&&(d=c,g--),d>c&&(d=c)),P=ar(this._tTime,p),!o&&this._tTime&&P!==g&&(P=g),A&&g&1&&(d=c-d,b=1),g!==P&&!this._lock)){var C=A&&P&1,x=C===(A&&g&1);if(g<P&&(C=!C),o=C?0:c,this._lock=1,this.render(o||(b?0:Ft(g*p)),s,!c)._lock=0,!s&&this.parent&&Be(this,"onRepeat"),this.vars.repeatRefresh&&!b&&(this.invalidate()._lock=1),o!==this._time||f!==!this._ts)return this;if(c=this._dur,l=this._tDur,x&&(this._lock=2,o=C?c:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!b&&this.invalidate()),this._lock=0,!this._ts&&!f)return this;Qh(this,b)}if(this._hasPause&&!this._forcing&&this._lock<2&&(S=p0(this,Ft(o),Ft(d)),S&&(h-=d-(d=S._start))),this._tTime=h,this._time=d,this._act=!v,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i),!o&&d&&!s&&Be(this,"onStart"),d>=o&&i>=0)for(m=this._first;m;){if(_=m._next,(m._act||d>=m._start)&&m._ts&&S!==m){if(m.parent!==this)return this.render(i,s,a);if(m.render(m._ts>0?(d-m._start)*m._ts:(m._dirty?m.totalDuration():m._tDur)+(d-m._start)*m._ts,s,a),d!==this._time||!this._ts&&!f){S=0,_&&(h+=this._zTime=-Yt);break}}m=_}else{m=this._last;for(var M=i<0?i:d;m;){if(_=m._prev,(m._act||M<=m._end)&&m._ts&&S!==m){if(m.parent!==this)return this.render(i,s,a);if(m.render(m._ts>0?(M-m._start)*m._ts:(m._dirty?m.totalDuration():m._tDur)+(M-m._start)*m._ts,s,a),d!==this._time||!this._ts&&!f){S=0,_&&(h+=this._zTime=M?-Yt:Yt);break}}m=_}}if(S&&!s&&(this.pause(),S.render(d>=o?0:-Yt)._zTime=d>=o?1:-1,this._ts))return this._start=E,el(this),this.render(i,s,a);this._onUpdate&&!s&&Be(this,"onUpdate",!0),(h===l&&l>=this.totalDuration()||!h&&o)&&(E===this._start||Math.abs(v)!==Math.abs(this._ts))&&(this._lock||((i||!c)&&(h===l&&this._ts>0||!h&&this._ts<0)&&Kn(this,1),!s&&!(i<0&&!o)&&(h||o)&&(Be(this,h===l?"onComplete":"onReverseComplete",!0),this._prom&&!(h<l&&this.timeScale()>0)&&this._prom())))}return this},e.add=function(i,s){var a=this;if(rn(s)||(s=ye(this,s)),!(i instanceof Ur)){if($e(i))return i.forEach(function(o){return a.add(o,s)}),this;if(Se(i))return this.addLabel(i,s);if(pe(i))i=le.delayedCall(0,i);else return this}return this!==i?Cn(this,i,s):this},e.getChildren=function(i,s,a,o){i===void 0&&(i=!0),s===void 0&&(s=!0),a===void 0&&(a=!0),o===void 0&&(o=-pn);for(var l=[],c=this._first;c;)c._start>=o&&(c instanceof le?s&&l.push(c):(a&&l.push(c),i&&l.push.apply(l,c.getChildren(!0,s,a)))),c=c._next;return l},e.getById=function(i){for(var s=this.getChildren(1,1,1),a=s.length;a--;)if(s[a].vars.id===i)return s[a]},e.remove=function(i){return Se(i)?this.removeLabel(i):pe(i)?this.killTweensOf(i):(Ws(this,i),i===this._recent&&(this._recent=this._last),vi(this))},e.totalTime=function(i,s){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=Ft(Xe.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),r.prototype.totalTime.call(this,i,s),this._forcing=0,this):this._tTime},e.addLabel=function(i,s){return this.labels[i]=ye(this,s),this},e.removeLabel=function(i){return delete this.labels[i],this},e.addPause=function(i,s,a){var o=le.delayedCall(0,s||Vr,a);return o.data="isPause",this._hasPause=1,Cn(this,o,ye(this,i))},e.removePause=function(i){var s=this._first;for(i=ye(this,i);s;)s._start===i&&s.data==="isPause"&&Kn(s),s=s._next},e.killTweensOf=function(i,s,a){for(var o=this.getTweensOf(i,a),l=o.length;l--;)Vn!==o[l]&&o[l].kill(i,s);return this},e.getTweensOf=function(i,s){for(var a=[],o=un(i),l=this._first,c=rn(s),h;l;)l instanceof le?o0(l._targets,o)&&(c?(!Vn||l._initted&&l._ts)&&l.globalTime(0)<=s&&l.globalTime(l.totalDuration())>s:!s||l.isActive())&&a.push(l):(h=l.getTweensOf(o,s)).length&&a.push.apply(a,h),l=l._next;return a},e.tweenTo=function(i,s){s=s||{};var a=this,o=ye(a,i),l=s,c=l.startAt,h=l.onStart,u=l.onStartParams,d=le.to(a,Ze(s,{ease:"none",lazy:!1,time:o,overwrite:"auto",duration:s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale())||Yt,onStart:function(){a.pause();var _=s.duration||Math.abs((o-a._time)/a.timeScale());d._dur!==_&&or(d,_,0,1).render(d._time,!0,!0),h&&h.apply(d,u||[])}}));return d},e.tweenFromTo=function(i,s,a){return this.tweenTo(s,Ze({startAt:{time:ye(this,i)}},a))},e.recent=function(){return this._recent},e.nextLabel=function(i){return i===void 0&&(i=this._time),Cc(this,ye(this,i))},e.previousLabel=function(i){return i===void 0&&(i=this._time),Cc(this,ye(this,i),1)},e.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+Yt)},e.shiftChildren=function(i,s,a){a===void 0&&(a=0);for(var o=this._first,l=this.labels,c;o;)o._start>=a&&(o._start+=i,o._end+=i),o=o._next;if(s)for(c in l)l[c]>=a&&(l[c]+=i);return vi(this)},e.invalidate=function(){var i=this._first;for(this._lock=0;i;)i.invalidate(),i=i._next;return r.prototype.invalidate.call(this)},e.clear=function(i){i===void 0&&(i=!0);for(var s=this._first,a;s;)a=s._next,this.remove(s),s=a;return this._time=this._tTime=this._pTime=0,i&&(this.labels={}),vi(this)},e.totalDuration=function(i){var s=0,a=this,o=a._last,l=pn,c,h,u;if(arguments.length)return a.timeScale((a._repeat<0?a.duration():a.totalDuration())/(a.reversed()?-i:i));if(a._dirty){for(u=a.parent;o;)c=o._prev,o._dirty&&o.totalDuration(),h=o._start,h>l&&a._sort&&o._ts&&!a._lock?(a._lock=1,Cn(a,o,h-o._delay,1)._lock=0):l=h,h<0&&o._ts&&(s-=h,(!u&&!a._dp||u&&u.smoothChildTiming)&&(a._start+=h/a._ts,a._time-=h,a._tTime-=h),a.shiftChildren(-h,!1,-1/0),l=0),o._end>s&&o._ts&&(s=o._end),o=c;or(a,a===ce&&a._time>s?a._time:s,1,1),a._dirty=0}return a._tDur},t.updateRoot=function(i){if(ce._ts&&(Fh(ce,Ds(i,ce)),Ih=Xe.frame),Xe.frame>=Tc){Tc+=Ke.autoSleep||120;var s=ce._first;if((!s||!s._ts)&&Ke.autoSleep&&Xe._listeners.length<2){for(;s&&!s._ts;)s=s._next;s||Xe.sleep()}}},t}(Ur);Ze(Ce.prototype,{_lock:0,_hasPause:0,_forcing:0});var L0=function(t,e,n,i,s,a,o){var l=new De(this._pt,t,e,0,1,au,null,s),c=0,h=0,u,d,m,_,g,p,f,S;for(l.b=n,l.e=i,n+="",i+="",(f=~i.indexOf("random("))&&(i=Xs(i)),a&&(S=[n,i],a(S,t,e),n=S[0],i=S[1]),d=n.match(La)||[];u=La.exec(i);)_=u[0],g=i.substring(c,u.index),m?m=(m+1)%5:g.substr(-5)==="rgba("&&(m=1),_!==d[h++]&&(p=parseFloat(d[h-1])||0,l._pt={_next:l._pt,p:g||h===1?g:",",s:p,c:_.charAt(1)==="="?parseFloat(_.substr(2))*(_.charAt(0)==="-"?-1:1):parseFloat(_)-p,m:m&&m<4?Math.round:0},c=La.lastIndex);return l.c=c<i.length?i.substring(c,i.length):"",l.fp=o,(wh.test(i)||f)&&(l.e=0),this._pt=l,l},il=function(t,e,n,i,s,a,o,l,c){pe(i)&&(i=i(s||0,t,a));var h=t[e],u=n!=="get"?n:pe(h)?c?t[e.indexOf("set")||!pe(t["get"+e.substr(3)])?e:"get"+e.substr(3)](c):t[e]():h,d=pe(h)?c?F0:ru:rl,m;if(Se(i)&&(~i.indexOf("random(")&&(i=Xs(i)),i.charAt(1)==="="&&(i=parseFloat(u)+parseFloat(i.substr(2))*(i.charAt(0)==="-"?-1:1)+(mn(u)||0))),u!==i)return isNaN(u*i)?(!h&&!(e in t)&&jo(e,i),L0.call(this,t,e,u,i,d,l||Ke.stringFilter,c)):(m=new De(this._pt,t,e,+u||0,i-(u||0),typeof h=="boolean"?B0:su,0,d),c&&(m.fp=c),o&&m.modifier(o,this,t),this._pt=m)},D0=function(t,e,n,i,s){if(pe(t)&&(t=Cr(t,s,e,n,i)),!Dn(t)||t.style&&t.nodeType||$e(t)||Ah(t))return Se(t)?Cr(t,s,e,n,i):t;var a={},o;for(o in t)a[o]=Cr(t[o],s,e,n,i);return a},nu=function(t,e,n,i,s,a){var o,l,c,h;if(Oe[t]&&(o=new Oe[t]).init(s,o.rawVars?e[t]:D0(e[t],i,s,a,n),n,i,a)!==!1&&(n._pt=l=new De(n._pt,s,t,0,1,o.render,o,0,o.priority),n!==Wi))for(c=n._ptLookup[n._targets.indexOf(s)],h=o._props.length;h--;)c[o._props[h]]=l;return o},Vn,U0=function r(t,e){var n=t.vars,i=n.ease,s=n.startAt,a=n.immediateRender,o=n.lazy,l=n.onUpdate,c=n.onUpdateParams,h=n.callbackScope,u=n.runBackwards,d=n.yoyoEase,m=n.keyframes,_=n.autoRevert,g=t._dur,p=t._startAt,f=t._targets,S=t.parent,v=S&&S.data==="nested"?S.parent._targets:f,E=t._overwrite==="auto",P=t.timeline,A,b,C,x,M,R,O,F,H,W,V,Y,G;if(P&&(!m||!i)&&(i="none"),t._ease=Zi(i,rr.ease),t._yEase=d?Jh(Zi(d===!0?i:d,rr.ease)):0,d&&t._yoyo&&!t._repeat&&(d=t._yEase,t._yEase=t._ease,t._ease=d),!P){if(F=f[0]?gi(f[0]).harness:0,Y=F&&n[F.prop],A=wo(n,Jo),p&&p.render(-1,!0).kill(),s){if(Kn(t._startAt=le.set(f,Ze({data:"isStart",overwrite:!1,parent:S,immediateRender:!0,lazy:Le(o),startAt:null,delay:0,onUpdate:l,onUpdateParams:c,callbackScope:h,stagger:0},s))),a){if(e>0)_||(t._startAt=0);else if(g&&!(e<0&&p)){e&&(t._zTime=e);return}}}else if(u&&g){if(p)!_&&(t._startAt=0);else if(e&&(a=!1),C=Ze({overwrite:!1,data:"isFromStart",lazy:a&&Le(o),immediateRender:a,stagger:0,parent:S},A),Y&&(C[F.prop]=Y),Kn(t._startAt=le.set(f,C)),!a)r(t._startAt,Yt);else if(!e)return}for(t._pt=0,o=g&&Le(o)||o&&!g,b=0;b<f.length;b++){if(M=f[b],O=M._gsap||tl(f)[b]._gsap,t._ptLookup[b]=W={},bo[O.id]&&Yn.length&&Ls(),V=v===f?b:v.indexOf(M),F&&(H=new F).init(M,Y||A,t,V,v)!==!1&&(t._pt=x=new De(t._pt,M,H.name,0,1,H.render,H,0,H.priority),H._props.forEach(function(st){W[st]=x}),H.priority&&(R=1)),!F||Y)for(C in A)Oe[C]&&(H=nu(C,A,t,V,M,v))?H.priority&&(R=1):W[C]=x=il.call(t,M,C,"get",A[C],V,v,0,n.stringFilter);t._op&&t._op[b]&&t.kill(M,t._op[b]),E&&t._pt&&(Vn=t,ce.killTweensOf(M,W,t.globalTime(0)),G=!t.parent,Vn=0),t._pt&&o&&(bo[O.id]=1)}R&&ou(t),t._onInit&&t._onInit(t)}t._from=!P&&!!n.runBackwards,t._onUpdate=l,t._initted=(!t._op||t._pt)&&!G},I0=function(t,e){var n=t[0]?gi(t[0]).harness:0,i=n&&n.aliases,s,a,o,l;if(!i)return e;s=sr({},e);for(a in i)if(a in s)for(l=i[a].split(","),o=l.length;o--;)s[l[o]]=s[a];return s},Cr=function(t,e,n,i,s){return pe(t)?t.call(e,n,i,s):Se(t)&&~t.indexOf("random(")?Xs(t):t},iu=Qo+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase",N0=(iu+",id,stagger,delay,duration,paused,scrollTrigger").split(","),le=function(r){yh(t,r);function t(n,i,s,a){var o;typeof i=="number"&&(s.duration=i,i=s,s=null),o=r.call(this,a?i:Es(i),s)||this;var l=o.vars,c=l.duration,h=l.delay,u=l.immediateRender,d=l.stagger,m=l.overwrite,_=l.keyframes,g=l.defaults,p=l.scrollTrigger,f=l.yoyoEase,S=o.parent,v=($e(n)||Ah(n)?rn(n[0]):"length"in i)?[n]:un(n),E,P,A,b,C,x,M,R;if(o._targets=v.length?tl(v):Dh("GSAP target "+n+" not found. https://greensock.com",!Ke.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=m,_||d||Ec(c)||Ec(h)){if(i=o.vars,E=o.timeline=new Ce({data:"nested",defaults:g||{}}),E.kill(),E.parent=Tn(o),_)Ze(E.vars.defaults,{ease:"none"}),_.forEach(function(O){return E.to(v,O,">")});else{if(b=v.length,M=d?Wh(d):Vr,Dn(d))for(C in d)~iu.indexOf(C)&&(R||(R={}),R[C]=d[C]);for(P=0;P<b;P++){A={};for(C in i)N0.indexOf(C)<0&&(A[C]=i[C]);A.stagger=0,f&&(A.yoyoEase=f),R&&sr(A,R),x=v[P],A.duration=+Cr(c,Tn(o),P,x,v),A.delay=(+Cr(h,Tn(o),P,x,v)||0)-o._delay,!d&&b===1&&A.delay&&(o._delay=h=A.delay,o._start+=h,A.delay=0),E.to(x,A,M(P,x,v))}E.duration()?c=h=0:o.timeline=0}c||o.duration(c=E.duration())}else o.timeline=0;return m===!0&&(Vn=Tn(o),ce.killTweensOf(v),Vn=0),S&&nl(S,Tn(o)),(u||!c&&!_&&o._start===Ft(S._time)&&Le(u)&&d0(Tn(o))&&S.data!=="nested")&&(o._tTime=-Yt,o.render(Math.max(0,-h))),p&&kh(Tn(o),p),o}var e=t.prototype;return e.render=function(i,s,a){var o=this._time,l=this._tDur,c=this._dur,h=i>l-Yt&&i>=0?l:i<Yt?0:i,u,d,m,_,g,p,f,S,v;if(!c)f0(this,i,s,a);else if(h!==this._tTime||!i||a||this._startAt&&this._zTime<0!=i<0){if(u=h,S=this.timeline,this._repeat){if(_=c+this._rDelay,u=Ft(h%_),h===l?(m=this._repeat,u=c):(m=~~(h/_),m&&m===h/_&&(u=c,m--),u>c&&(u=c)),p=this._yoyo&&m&1,p&&(v=this._yEase,u=c-u),g=ar(this._tTime,_),u===o&&!a&&this._initted)return this;m!==g&&(S&&this._yEase&&Qh(S,p),this.vars.repeatRefresh&&!p&&!this._lock&&(this._lock=a=1,this.render(Ft(_*m),!0).invalidate()._lock=0))}if(!this._initted){if(Vh(this,i<0?i:u,a,s))return this._tTime=0,this;if(c!==this._dur)return this.render(i,s,a)}for(this._tTime=h,this._time=u,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=f=(v||this._ease)(u/c),this._from&&(this.ratio=f=1-f),u&&!o&&!s&&Be(this,"onStart"),d=this._pt;d;)d.r(f,d.d),d=d._next;S&&S.render(i<0?i:!u&&p?-Yt:S._dur*f,s,a)||this._startAt&&(this._zTime=i),this._onUpdate&&!s&&(i<0&&this._startAt&&this._startAt.render(i,!0,a),Be(this,"onUpdate")),this._repeat&&m!==g&&this.vars.onRepeat&&!s&&this.parent&&Be(this,"onRepeat"),(h===this._tDur||!h)&&this._tTime===h&&(i<0&&this._startAt&&!this._onUpdate&&this._startAt.render(i,!0,!0),(i||!c)&&(h===this._tDur&&this._ts>0||!h&&this._ts<0)&&Kn(this,1),!s&&!(i<0&&!o)&&(h||o)&&(Be(this,h===l?"onComplete":"onReverseComplete",!0),this._prom&&!(h<l&&this.timeScale()>0)&&this._prom()))}return this},e.targets=function(){return this._targets},e.invalidate=function(){return this._pt=this._op=this._startAt=this._onUpdate=this._act=this._lazy=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(),r.prototype.invalidate.call(this)},e.kill=function(i,s){if(s===void 0&&(s="all"),!i&&(!s||s==="all")&&(this._lazy=0,this.parent))return Er(this);if(this.timeline){var a=this.timeline.totalDuration();return this.timeline.killTweensOf(i,s,Vn&&Vn.vars.overwrite!==!0)._first||Er(this),this.parent&&a!==this.timeline.totalDuration()&&or(this,this._dur*this.timeline._tDur/a,0,1),this}var o=this._targets,l=i?un(i):o,c=this._ptLookup,h=this._pt,u,d,m,_,g,p,f;if((!s||s==="all")&&c0(o,l))return s==="all"&&(this._pt=0),Er(this);for(u=this._op=this._op||[],s!=="all"&&(Se(s)&&(g={},ze(s,function(S){return g[S]=1}),s=g),s=I0(o,s)),f=o.length;f--;)if(~l.indexOf(o[f])){d=c[f],s==="all"?(u[f]=s,_=d,m={}):(m=u[f]=u[f]||{},_=s);for(g in _)p=d&&d[g],p&&((!("kill"in p.d)||p.d.kill(g)===!0)&&Ws(this,p,"_pt"),delete d[g]),m!=="all"&&(m[g]=1)}return this._initted&&!this._pt&&h&&Er(this),this},t.to=function(i,s){return new t(i,s,arguments[2])},t.from=function(i,s){return new t(i,wr(arguments,1))},t.delayedCall=function(i,s,a,o){return new t(s,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:s,onReverseComplete:s,onCompleteParams:a,onReverseCompleteParams:a,callbackScope:o})},t.fromTo=function(i,s,a){return new t(i,wr(arguments,2))},t.set=function(i,s){return s.duration=0,s.repeatDelay||(s.repeat=0),new t(i,s)},t.killTweensOf=function(i,s,a){return ce.killTweensOf(i,s,a)},t}(Ur);Ze(le.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});ze("staggerTo,staggerFrom,staggerFromTo",function(r){le[r]=function(){var t=new Ce,e=Co.call(arguments,0);return e.splice(r==="staggerFromTo"?5:4,0,0),t[r].apply(t,e)}});var rl=function(t,e,n){return t[e]=n},ru=function(t,e,n){return t[e](n)},F0=function(t,e,n,i){return t[e](i.fp,n)},O0=function(t,e,n){return t.setAttribute(e,n)},sl=function(t,e){return pe(t[e])?ru:Zo(t[e])&&t.setAttribute?O0:rl},su=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4,e)},B0=function(t,e){return e.set(e.t,e.p,!!(e.s+e.c*t),e)},au=function(t,e){var n=e._pt,i="";if(!t&&e.b)i=e.b;else if(t===1&&e.e)i=e.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*t):Math.round((n.s+n.c*t)*1e4)/1e4)+i,n=n._next;i+=e.c}e.set(e.t,e.p,i,e)},al=function(t,e){for(var n=e._pt;n;)n.r(t,n.d),n=n._next},z0=function(t,e,n,i){for(var s=this._pt,a;s;)a=s._next,s.p===i&&s.modifier(t,e,n),s=a},k0=function(t){for(var e=this._pt,n,i;e;)i=e._next,e.p===t&&!e.op||e.op===t?Ws(this,e,"_pt"):e.dep||(n=1),e=i;return!n},V0=function(t,e,n,i){i.mSet(t,e,i.m.call(i.tween,n,i.mt),i)},ou=function(t){for(var e=t._pt,n,i,s,a;e;){for(n=e._next,i=s;i&&i.pr>e.pr;)i=i._next;(e._prev=i?i._prev:a)?e._prev._next=e:s=e,(e._next=i)?i._prev=e:a=e,e=n}t._pt=s},De=function(){function r(e,n,i,s,a,o,l,c,h){this.t=n,this.s=s,this.c=a,this.p=i,this.r=o||su,this.d=l||this,this.set=c||rl,this.pr=h||0,this._next=e,e&&(e._prev=this)}var t=r.prototype;return t.modifier=function(n,i,s){this.mSet=this.mSet||this.set,this.set=V0,this.m=n,this.mt=s,this.tween=i},r}();ze(Qo+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(r){return Jo[r]=1});Ve.TweenMax=Ve.TweenLite=le;Ve.TimelineLite=Ve.TimelineMax=Ce;ce=new Ce({sortChildren:!1,defaults:rr,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});Ke.stringFilter=jh;var Is={registerPlugin:function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];e.forEach(function(i){return T0(i)})},timeline:function(t){return new Ce(t)},getTweensOf:function(t,e){return ce.getTweensOf(t,e)},getProperty:function(t,e,n,i){Se(t)&&(t=un(t)[0]);var s=gi(t||{}).get,a=n?Bh:Oh;return n==="native"&&(n=""),t&&(e?a((Oe[e]&&Oe[e].get||s)(t,e,n,i)):function(o,l,c){return a((Oe[o]&&Oe[o].get||s)(t,o,l,c))})},quickSetter:function(t,e,n){if(t=un(t),t.length>1){var i=t.map(function(h){return _n.quickSetter(h,e,n)}),s=i.length;return function(h){for(var u=s;u--;)i[u](h)}}t=t[0]||{};var a=Oe[e],o=gi(t),l=o.harness&&(o.harness.aliases||{})[e]||e,c=a?function(h){var u=new a;Wi._pt=0,u.init(t,n?h+n:h,Wi,0,[t]),u.render(1,u),Wi._pt&&al(1,Wi)}:o.set(t,l);return a?c:function(h){return c(t,l,n?h+n:h,o,1)}},isTweening:function(t){return ce.getTweensOf(t,!0).length>0},defaults:function(t){return t&&t.ease&&(t.ease=Zi(t.ease,rr.ease)),Ac(rr,t||{})},config:function(t){return Ac(Ke,t||{})},registerEffect:function(t){var e=t.name,n=t.effect,i=t.plugins,s=t.defaults,a=t.extendTimeline;(i||"").split(",").forEach(function(o){return o&&!Oe[o]&&!Ve[o]&&Dh(e+" effect requires "+o+" plugin.")}),Da[e]=function(o,l,c){return n(un(o),Ze(l||{},s),c)},a&&(Ce.prototype[e]=function(o,l,c){return this.add(Da[e](o,Dn(l)?l:(c=l)&&{},this),c)})},registerEase:function(t,e){Bt[t]=Zi(e)},parseEase:function(t,e){return arguments.length?Zi(t,e):Bt},getById:function(t){return ce.getById(t)},exportRoot:function(t,e){t===void 0&&(t={});var n=new Ce(t),i,s;for(n.smoothChildTiming=Le(t.smoothChildTiming),ce.remove(n),n._dp=0,n._time=n._tTime=ce._time,i=ce._first;i;)s=i._next,(e||!(!i._dur&&i instanceof le&&i.vars.onComplete===i._targets[0]))&&Cn(n,i,i._start-i._delay),i=s;return Cn(ce,n,0),n},utils:{wrap:S0,wrapYoyo:y0,distribute:Wh,random:Yh,snap:Xh,normalize:M0,getUnit:mn,clamp:_0,splitColor:Kh,toArray:un,mapRange:$h,pipe:v0,unitize:x0,interpolate:E0,shuffle:Gh},install:Lh,effects:Da,ticker:Xe,updateRoot:Ce.updateRoot,plugins:Oe,globalTimeline:ce,core:{PropTween:De,globals:Uh,Tween:le,Timeline:Ce,Animation:Ur,getCache:gi,_removeLinkedListItem:Ws}};ze("to,from,fromTo,delayedCall,set,killTweensOf",function(r){return Is[r]=le[r]});Xe.add(Ce.updateRoot);Wi=Is.to({},{duration:0});var H0=function(t,e){for(var n=t._pt;n&&n.p!==e&&n.op!==e&&n.fp!==e;)n=n._next;return n},G0=function(t,e){var n=t._targets,i,s,a;for(i in e)for(s=n.length;s--;)a=t._ptLookup[s][i],a&&(a=a.d)&&(a._pt&&(a=H0(a,i)),a&&a.modifier&&a.modifier(e[i],t,n[s],i))},Fa=function(t,e){return{name:t,rawVars:1,init:function(i,s,a){a._onInit=function(o){var l,c;if(Se(s)&&(l={},ze(s,function(h){return l[h]=1}),s=l),e){l={};for(c in s)l[c]=e(s[c]);s=l}G0(o,s)}}}},_n=Is.registerPlugin({name:"attr",init:function(t,e,n,i,s){var a,o;for(a in e)o=this.add(t,"setAttribute",(t.getAttribute(a)||0)+"",e[a],i,s,0,0,a),o&&(o.op=a),this._props.push(a)}},{name:"endArray",init:function(t,e){for(var n=e.length;n--;)this.add(t,n,t[n]||0,e[n])}},Fa("roundProps",Ro),Fa("modifiers"),Fa("snap",Xh))||Is;le.version=Ce.version=_n.version="3.5.1";Ph=1;Th()&&lr();Bt.Power0;Bt.Power1;Bt.Power2;Bt.Power3;Bt.Power4;Bt.Linear;Bt.Quad;Bt.Cubic;Bt.Quart;Bt.Quint;Bt.Strong;Bt.Elastic;Bt.Back;Bt.SteppedEase;Bt.Bounce;Bt.Sine;Bt.Expo;Bt.Circ;/*!
 * CSSPlugin 3.5.1
 * https://greensock.com
 *
 ...
 * Club GreenSock members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var Pc,dn,ji,ol,_i,Ar,Lc,W0=function(){return typeof window<"u"},Zn={},ui=180/Math.PI,Ji=Math.PI/180,Vi=Math.atan2,Dc=1e8,lu=/([A-Z])/g,X0=/(?:left|right|width|margin|padding|x)/i,Y0=/[\s,\(]\S/,Hn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},cu=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},q0=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},$0=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},K0=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},hu=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},uu=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},Z0=function(t,e,n){return t.style[e]=n},j0=function(t,e,n){return t.style.setProperty(e,n)},J0=function(t,e,n){return t._gsap[e]=n},Q0=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},tv=function(t,e,n,i,s){var a=t._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},ev=function(t,e,n,i,s){var a=t._gsap;a[e]=n,a.renderTransform(s,a)},ke="transform",jn=ke+"Origin",du,Po=function(t,e){var n=dn.createElementNS?dn.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):dn.createElement(t);return n.style?n:dn.createElement(t)},Rn=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(lu,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,cr(e)||e,1)||""},Uc="O,Moz,ms,Ms,Webkit".split(","),cr=function(t,e,n){var i=e||_i,s=i.style,a=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);a--&&!(Uc[a]+t in s););return a<0?null:(a===3?"ms":a>=0?Uc[a]:"")+t},Lo=function(){W0()&&window.document&&(Pc=window,dn=Pc.document,ji=dn.documentElement,_i=Po("div")||{style:{}},Ar=Po("div"),ke=cr(ke),jn=ke+"Origin",_i.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",du=!!cr("perspective"),ol=1)},Oa=function r(t){var e=Po("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,s=this.style.cssText,a;if(ji.appendChild(e),e.appendChild(this),this.style.display="block",t)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=r}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),ji.removeChild(e),this.style.cssText=s,a},Ic=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},fu=function(t){var e;try{e=t.getBBox()}catch{e=Oa.call(t,!0)}return e&&(e.width||e.height)||t.getBBox===Oa||(e=Oa.call(t,!0)),e&&!e.width&&!e.x&&!e.y?{x:+Ic(t,["x","cx","x1"])||0,y:+Ic(t,["y","cy","y1"])||0,width:0,height:0}:e},pu=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&fu(t))},Ns=function(t,e){if(e){var n=t.style;e in Zn&&e!==jn&&(e=ke),n.removeProperty?((e.substr(0,2)==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(e.replace(lu,"-$1").toLowerCase())):n.removeAttribute(e)}},Gn=function(t,e,n,i,s,a){var o=new De(t._pt,e,n,0,1,a?uu:hu);return t._pt=o,o.b=i,o.e=s,t._props.push(n),o},Nc={deg:1,rad:1,turn:1},Si=function r(t,e,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=_i.style,l=X0.test(e),c=t.tagName.toLowerCase()==="svg",h=(c?"client":"offset")+(l?"Width":"Height"),u=100,d=i==="px",m=i==="%",_,g,p,f;return i===a||!s||Nc[i]||Nc[a]?s:(a!=="px"&&!d&&(s=r(t,e,n,"px")),f=t.getCTM&&pu(t),m&&(Zn[e]||~e.indexOf("adius"))?Ft(s/(f?t.getBBox()[l?"width":"height"]:t[h])*u):(o[l?"width":"height"]=u+(d?a:i),g=~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,f&&(g=(t.ownerSVGElement||{}).parentNode),(!g||g===dn||!g.appendChild)&&(g=dn.body),p=g._gsap,p&&m&&p.width&&l&&p.time===Xe.time?Ft(s/p.width*u):((m||a==="%")&&(o.position=Rn(t,"position")),g===t&&(o.position="static"),g.appendChild(_i),_=_i[h],g.removeChild(_i),o.position="absolute",l&&m&&(p=gi(g),p.time=Xe.time,p.width=g[h]),Ft(d?_*s/u:_&&s?u/_*s:0))))},br=function(t,e,n,i){var s;return ol||Lo(),e in Hn&&e!=="transform"&&(e=Hn[e],~e.indexOf(",")&&(e=e.split(",")[0])),Zn[e]&&e!=="transform"?(s=Ys(t,i),s=e!=="transformOrigin"?s[e]:Os(Rn(t,jn))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=Fs[e]&&Fs[e](t,e,n)||Rn(t,e)||Nh(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").indexOf(" ")?Si(t,e,s,n)+n:s},nv=function(t,e,n,i){if(!n||n==="none"){var s=cr(e,t,1),a=s&&Rn(t,s,1);a&&a!==n?(e=s,n=a):e==="borderColor"&&(n=Rn(t,"borderTopColor"))}var o=new De(this._pt,t.style,e,0,1,au),l=0,c=0,h,u,d,m,_,g,p,f,S,v,E,P,A;if(o.b=n,o.e=i,n+="",i+="",i==="auto"&&(t.style[e]=i,i=Rn(t,e)||i,t.style[e]=n),h=[n,i],jh(h),n=h[0],i=h[1],d=n.match(Gi)||[],A=i.match(Gi)||[],A.length){for(;u=Gi.exec(i);)p=u[0],S=i.substring(l,u.index),_?_=(_+1)%5:(S.substr(-5)==="rgba("||S.substr(-5)==="hsla(")&&(_=1),p!==(g=d[c++]||"")&&(m=parseFloat(g)||0,E=g.substr((m+"").length),P=p.charAt(1)==="="?+(p.charAt(0)+"1"):0,P&&(p=p.substr(2)),f=parseFloat(p),v=p.substr((f+"").length),l=Gi.lastIndex-v.length,v||(v=v||Ke.units[e]||E,l===i.length&&(i+=v,o.e+=v)),E!==v&&(m=Si(t,e,g,v)||0),o._pt={_next:o._pt,p:S||c===1?S:",",s:m,c:P?P*f:f-m,m:_&&_<4?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=e==="display"&&i==="none"?uu:hu;return wh.test(i)&&(o.e=0),this._pt=o,o},Fc={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},iv=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=Fc[n]||n,e[1]=Fc[i]||i,e.join(" ")},rv=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],Zn[o]&&(l=1,o=o==="transformOrigin"?jn:ke),Ns(n,o);l&&(Ns(n,ke),a&&(a.svg&&n.removeAttribute("transform"),Ys(n,1),a.uncache=1))}},Fs={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var a=t._pt=new De(t._pt,e,n,0,0,rv);return a.u=i,a.pr=-10,a.tween=s,t._props.push(n),1}}},Ir=[1,0,0,1,0,0],mu={},_u=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},Oc=function(t){var e=Rn(t,ke);return _u(e)?Ir:e.substr(7).match(bh).map(Ft)},ll=function(t,e){var n=t._gsap||gi(t),i=t.style,s=Oc(t),a,o,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?Ir:s):(s===Ir&&!t.offsetParent&&t!==ji&&!n.svg&&(l=i.display,i.display="block",a=t.parentNode,(!a||!t.offsetParent)&&(c=1,o=t.nextSibling,ji.appendChild(t)),s=Oc(t),l?i.display=l:Ns(t,"display"),c&&(o?a.insertBefore(t,o):a?a.appendChild(t):ji.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},Do=function(t,e,n,i,s,a){var o=t._gsap,l=s||ll(t,!0),c=o.xOrigin||0,h=o.yOrigin||0,u=o.xOffset||0,d=o.yOffset||0,m=l[0],_=l[1],g=l[2],p=l[3],f=l[4],S=l[5],v=e.split(" "),E=parseFloat(v[0])||0,P=parseFloat(v[1])||0,A,b,C,x;n?l!==Ir&&(b=m*p-_*g)&&(C=E*(p/b)+P*(-g/b)+(g*S-p*f)/b,x=E*(-_/b)+P*(m/b)-(m*S-_*f)/b,E=C,P=x):(A=fu(t),E=A.x+(~v[0].indexOf("%")?E/100*A.width:E),P=A.y+(~(v[1]||v[0]).indexOf("%")?P/100*A.height:P)),i||i!==!1&&o.smooth?(f=E-c,S=P-h,o.xOffset=u+(f*m+S*g)-f,o.yOffset=d+(f*_+S*p)-S):o.xOffset=o.yOffset=0,o.xOrigin=E,o.yOrigin=P,o.smooth=!!i,o.origin=e,o.originIsAbsolute=!!n,t.style[jn]="0px 0px",a&&(Gn(a,o,"xOrigin",c,E),Gn(a,o,"yOrigin",h,P),Gn(a,o,"xOffset",u,o.xOffset),Gn(a,o,"yOffset",d,o.yOffset)),t.setAttribute("data-svg-origin",E+" "+P)},Ys=function(t,e){var n=t._gsap||new eu(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,a="px",o="deg",l=Rn(t,jn)||"0",c,h,u,d,m,_,g,p,f,S,v,E,P,A,b,C,x,M,R,O,F,H,W,V,Y,G,st,ot,lt,It,Lt,X;return c=h=u=_=g=p=f=S=v=0,d=m=1,n.svg=!!(t.getCTM&&pu(t)),A=ll(t,n.svg),n.svg&&(V=!n.uncache&&t.getAttribute("data-svg-origin"),Do(t,V||l,!!V||n.originIsAbsolute,n.smooth!==!1,A)),E=n.xOrigin||0,P=n.yOrigin||0,A!==Ir&&(M=A[0],R=A[1],O=A[2],F=A[3],c=H=A[4],h=W=A[5],A.length===6?(d=Math.sqrt(M*M+R*R),m=Math.sqrt(F*F+O*O),_=M||R?Vi(R,M)*ui:0,f=O||F?Vi(O,F)*ui+_:0,f&&(m*=Math.cos(f*Ji)),n.svg&&(c-=E-(E*M+P*O),h-=P-(E*R+P*F))):(X=A[6],It=A[7],st=A[8],ot=A[9],lt=A[10],Lt=A[11],c=A[12],h=A[13],u=A[14],b=Vi(X,lt),g=b*ui,b&&(C=Math.cos(-b),x=Math.sin(-b),V=H*C+st*x,Y=W*C+ot*x,G=X*C+lt*x,st=H*-x+st*C,ot=W*-x+ot*C,lt=X*-x+lt*C,Lt=It*-x+Lt*C,H=V,W=Y,X=G),b=Vi(-O,lt),p=b*ui,b&&(C=Math.cos(-b),x=Math.sin(-b),V=M*C-st*x,Y=R*C-ot*x,G=O*C-lt*x,Lt=F*x+Lt*C,M=V,R=Y,O=G),b=Vi(R,M),_=b*ui,b&&(C=Math.cos(b),x=Math.sin(b),V=M*C+R*x,Y=H*C+W*x,R=R*C-M*x,W=W*C-H*x,M=V,H=Y),g&&Math.abs(g)+Math.abs(_)>359.9&&(g=_=0,p=180-p),d=Ft(Math.sqrt(M*M+R*R+O*O)),m=Ft(Math.sqrt(W*W+X*X)),b=Vi(H,W),f=Math.abs(b)>2e-4?b*ui:0,v=Lt?1/(Lt<0?-Lt:Lt):0),n.svg&&(V=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!_u(Rn(t,ke)),V&&t.setAttribute("transform",V))),Math.abs(f)>90&&Math.abs(f)<270&&(s?(d*=-1,f+=_<=0?180:-180,_+=_<=0?180:-180):(m*=-1,f+=f<=0?180:-180)),n.x=((n.xPercent=c&&Math.round(t.offsetWidth/2)===Math.round(-c)?-50:0)?0:c)+a,n.y=((n.yPercent=h&&Math.round(t.offsetHeight/2)===Math.round(-h)?-50:0)?0:h)+a,n.z=u+a,n.scaleX=Ft(d),n.scaleY=Ft(m),n.rotation=Ft(_)+o,n.rotationX=Ft(g)+o,n.rotationY=Ft(p)+o,n.skewX=f+o,n.skewY=S+o,n.transformPerspective=v+a,(n.zOrigin=parseFloat(l.split(" ")[2])||0)&&(i[jn]=Os(l)),n.xOffset=n.yOffset=0,n.force3D=Ke.force3D,n.renderTransform=n.svg?av:du?gu:sv,n.uncache=0,n},Os=function(t){return(t=t.split(" "))[0]+" "+t[1]},Ba=function(t,e,n){var i=mn(e);return Ft(parseFloat(e)+parseFloat(Si(t,"x",n+"px",i)))+i},sv=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,gu(t,e)},oi="0deg",Mr="0px",li=") ",gu=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,h=n.rotationY,u=n.rotationX,d=n.skewX,m=n.skewY,_=n.scaleX,g=n.scaleY,p=n.transformPerspective,f=n.force3D,S=n.target,v=n.zOrigin,E="",P=f==="auto"&&t&&t!==1||f===!0;if(v&&(u!==oi||h!==oi)){var A=parseFloat(h)*Ji,b=Math.sin(A),C=Math.cos(A),x;A=parseFloat(u)*Ji,x=Math.cos(A),a=Ba(S,a,b*x*-v),o=Ba(S,o,-Math.sin(A)*-v),l=Ba(S,l,C*x*-v+v)}p!==Mr&&(E+="perspective("+p+li),(i||s)&&(E+="translate("+i+"%, "+s+"%) "),(P||a!==Mr||o!==Mr||l!==Mr)&&(E+=l!==Mr||P?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+li),c!==oi&&(E+="rotate("+c+li),h!==oi&&(E+="rotateY("+h+li),u!==oi&&(E+="rotateX("+u+li),(d!==oi||m!==oi)&&(E+="skew("+d+", "+m+li),(_!==1||g!==1)&&(E+="scale("+_+", "+g+li),S.style[ke]=E||"translate(0, 0)"},av=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,h=n.skewY,u=n.scaleX,d=n.scaleY,m=n.target,_=n.xOrigin,g=n.yOrigin,p=n.xOffset,f=n.yOffset,S=n.forceCSS,v=parseFloat(a),E=parseFloat(o),P,A,b,C,x;l=parseFloat(l),c=parseFloat(c),h=parseFloat(h),h&&(h=parseFloat(h),c+=h,l+=h),l||c?(l*=Ji,c*=Ji,P=Math.cos(l)*u,A=Math.sin(l)*u,b=Math.sin(l-c)*-d,C=Math.cos(l-c)*d,c&&(h*=Ji,x=Math.tan(c-h),x=Math.sqrt(1+x*x),b*=x,C*=x,h&&(x=Math.tan(h),x=Math.sqrt(1+x*x),P*=x,A*=x)),P=Ft(P),A=Ft(A),b=Ft(b),C=Ft(C)):(P=u,C=d,A=b=0),(v&&!~(a+"").indexOf("px")||E&&!~(o+"").indexOf("px"))&&(v=Si(m,"x",a,"px"),E=Si(m,"y",o,"px")),(_||g||p||f)&&(v=Ft(v+_-(_*P+g*b)+p),E=Ft(E+g-(_*A+g*C)+f)),(i||s)&&(x=m.getBBox(),v=Ft(v+i/100*x.width),E=Ft(E+s/100*x.height)),x="matrix("+P+","+A+","+b+","+C+","+v+","+E+")",m.setAttribute("transform",x),S&&(m.style[ke]=x)},ov=function(t,e,n,i,s,a){var o=360,l=Se(s),c=parseFloat(s)*(l&&~s.indexOf("rad")?ui:1),h=a?c*a:c-i,u=i+h+"deg",d,m;return l&&(d=s.split("_")[1],d==="short"&&(h%=o,h!==h%(o/2)&&(h+=h<0?o:-o)),d==="cw"&&h<0?h=(h+o*Dc)%o-~~(h/o)*o:d==="ccw"&&h>0&&(h=(h-o*Dc)%o-~~(h/o)*o)),t._pt=m=new De(t._pt,e,n,i,h,q0),m.e=u,m.u="deg",t._props.push(n),m},lv=function(t,e,n){var i=Ar.style,s=n._gsap,a="perspective,force3D,transformOrigin,svgOrigin",o,l,c,h,u,d,m,_;i.cssText=getComputedStyle(n).cssText+";position:absolute;display:block;",i[ke]=e,dn.body.appendChild(Ar),o=Ys(Ar,1);for(l in Zn)c=s[l],h=o[l],c!==h&&a.indexOf(l)<0&&(m=mn(c),_=mn(h),u=m!==_?Si(n,l,c,_):parseFloat(c),d=parseFloat(h),t._pt=new De(t._pt,s,l,u,d-u,cu),t._pt.u=_||0,t._props.push(l));dn.body.removeChild(Ar)};ze("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",a=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(o){return t<2?r+o:"border"+o+r});Fs[t>1?"border"+r:r]=function(o,l,c,h,u){var d,m;if(arguments.length<4)return d=a.map(function(_){return br(o,_,c)}),m=d.join(" "),m.split(d[0]).length===5?d[0]:m;d=(h+"").split(" "),m={},a.forEach(function(_,g){return m[_]=d[g]=d[g]||d[(g-1)/2|0]}),o.init(l,m,u)}});var vu={name:"css",register:Lo,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var a=this._props,o=t.style,l,c,h,u,d,m,_,g,p,f,S,v,E,P,A;ol||Lo();for(_ in e)if(_!=="autoRound"&&(c=e[_],!(Oe[_]&&nu(_,e,n,i,t,s)))){if(d=typeof c,m=Fs[_],d==="function"&&(c=c.call(n,i,t,s),d=typeof c),d==="string"&&~c.indexOf("random(")&&(c=Xs(c)),m)m(this,t,_,c,n)&&(A=1);else if(_.substr(0,2)==="--")this.add(o,"setProperty",getComputedStyle(t).getPropertyValue(_)+"",c+"",i,s,0,0,_);else if(d!=="undefined"){if(l=br(t,_),u=parseFloat(l),f=d==="string"&&c.charAt(1)==="="?+(c.charAt(0)+"1"):0,f&&(c=c.substr(2)),h=parseFloat(c),_ in Hn&&(_==="autoAlpha"&&(u===1&&br(t,"visibility")==="hidden"&&h&&(u=0),Gn(this,o,"visibility",u?"inherit":"hidden",h?"inherit":"hidden",!h)),_!=="scale"&&_!=="transform"&&(_=Hn[_],~_.indexOf(",")&&(_=_.split(",")[0]))),S=_ in Zn,S){if(v||(E=t._gsap,E.renderTransform||Ys(t),P=e.smoothOrigin!==!1&&E.smooth,v=this._pt=new De(this._pt,o,ke,0,1,E.renderTransform,E,0,-1),v.dep=1),_==="scale")this._pt=new De(this._pt,E,"scaleY",E.scaleY,f?f*h:h-E.scaleY),a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){c=iv(c),E.svg?Do(t,c,0,P,0,this):(p=parseFloat(c.split(" ")[2])||0,p!==E.zOrigin&&Gn(this,E,"zOrigin",E.zOrigin,p),Gn(this,o,_,Os(l),Os(c)));continue}else if(_==="svgOrigin"){Do(t,c,1,P,0,this);continue}else if(_ in mu){ov(this,E,_,u,c,f);continue}else if(_==="smoothOrigin"){Gn(this,E,"smooth",E.smooth,c);continue}else if(_==="force3D"){E[_]=c;continue}else if(_==="transform"){lv(this,c,t);continue}}else _ in o||(_=cr(_)||_);if(S||(h||h===0)&&(u||u===0)&&!Y0.test(c)&&_ in o)g=(l+"").substr((u+"").length),h||(h=0),p=mn(c)||(_ in Ke.units?Ke.units[_]:g),g!==p&&(u=Si(t,_,l,p)),this._pt=new De(this._pt,S?E:o,_,u,f?f*h:h-u,p==="px"&&e.autoRound!==!1&&!S?K0:cu),this._pt.u=p||0,g!==p&&(this._pt.b=l,this._pt.r=$0);else if(_ in o)nv.call(this,t,_,l,c);else if(_ in t)this.add(t,_,t[_],c,i,s);else{jo(_,c);continue}a.push(_)}}A&&ou(this)},get:br,aliases:Hn,getSetter:function(t,e,n){var i=Hn[e];return i&&i.indexOf(",")<0&&(e=i),e in Zn&&e!==jn&&(t._gsap.x||br(t,"x"))?n&&Lc===n?e==="scale"?Q0:J0:(Lc=n||{})&&(e==="scale"?tv:ev):t.style&&!Zo(t.style[e])?Z0:~e.indexOf("-")?j0:sl(t,e)},core:{_removeProperty:Ns,_getMatrix:ll}};_n.utils.checkPrefix=cr;(function(r,t,e,n){var i=ze(r+","+t+","+e,function(s){Zn[s]=1});ze(t,function(s){Ke.units[s]="deg",mu[s]=1}),Hn[i[13]]=r+","+t,ze(n,function(s){var a=s.split(":");Hn[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");ze("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){Ke.units[r]="px"});_n.registerPlugin(vu);var xu=_n.registerPlugin(vu)||_n;xu.core.Tween;const Mu=new Ko;Mu.hide();const cv=new Sh;cv.onError=r=>console.error("There was an error loading "+r);const hv=new zg,cl=hv.load("/textures/gradients/5.jpg"),Rr={materialColor:"#1892eb"};cl.minFilter=Re;cl.magFilter=Re;Mu.addColor(Rr,"materialColor").onChange(()=>{qs.color.set(Rr.materialColor),Su.color.set(Rr.materialColor)});const uv=document.querySelector("canvas.webgl"),Gr=new Ig,hr=4,qs=new Fg({color:Rr.materialColor,gradientMap:cl}),$s=new Ye(new Yo(1,.4,16,60),qs),Ks=new Ye(new Xo(1,2,32),qs),Zs=new Ye(new qo(.8,.35,100,16),qs);Gr.add($s,Ks,Zs);const hl=[$s,Ks,Zs];$s.position.y=-hr*0;Ks.position.y=-hr*1;Zs.position.y=-hr*2;$s.position.x=2;Ks.position.x=-2;Zs.position.x=2;const ul=500,dl=new je,Ts=new Float32Array(ul*3),dv=new Float32Array(ul*3);for(let r=0;r<ul*3;r++){const t=r*3;Ts[t+0]=(Math.random()-.5)*10,Ts[t+1]=hr*.5-Math.random()*hr*hl.length,Ts[t+2]=(Math.random()-.5)*10}dl.setAttribute("position",new qe(Ts,3));dl.setAttribute("color",new qe(dv,3));const Su=new Mh({size:.03,sizeAttenuation:!0,color:Rr.materialColor}),fv=new Ng(dl,Su);Gr.add(fv);const yu=new Gg("#ffffff",3);yu.position.set(0,1,1);Gr.add(yu);const we={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{we.width=window.innerWidth,we.height=window.innerHeight,ur.aspect=we.width/we.height,ur.updateProjectionMatrix(),Nr.setSize(we.width,we.height),Nr.setPixelRatio(Math.min(window.devicePixelRatio,2))});const Xi=new yr;Gr.add(Xi);const ur=new We(35,we.width/we.height,.1,100);ur.position.z=6;Xi.add(ur);const Nr=new Ug({canvas:uv,alpha:!0});Nr.setSize(we.width,we.height);Nr.setPixelRatio(Math.min(window.devicePixelRatio,2));let Uo=window.scrollY,za=0;window.addEventListener("scroll",()=>{Uo=window.scrollY;const r=Math.round(Uo/we.height);r!==za&&(za=r,xu.to(hl[za].rotation,{duration:1.5,ease:"power2.inOut",x:"+=6",y:"+=3",z:"+=1.5n"}))});const Bs={x:0,y:0};window.addEventListener("mousemove",r=>{Bs.x=r.clientX/we.width-.5,Bs.y=-(r.clientY/we.height-.5)});const pv=new Wg;let Bc=0;const Eu=()=>{const r=pv.getElapsedTime(),t=r-Bc;Bc=r,ur.position.y=-Uo/we.height*hr;for(const i of hl)i.rotation.x+=t*.1,i.rotation.y+=t*.12;const e=Bs.x*.5,n=-Bs.y*.5;Xi.position.x+=(e-Xi.position.x)*t*5,Xi.position.y+=(n-Xi.position.y)*t*5,Nr.render(Gr,ur),window.requestAnimationFrame(Eu)};Eu();
//# sourceMappingURL=index-RkeoDnzG.js.map
